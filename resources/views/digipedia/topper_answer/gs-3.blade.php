                    ...
                    <div class="lernen_banner_title">
                        ...
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                ...
                                <span class="last-item">GS-3</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                ...
                                <h4>ANSWER-1</h4>
                                <a href="https://drive.google.com/file/d/1C-qJfGU3_VUzuRIkvuUjAyjgut0lgF8I/view?usp=sharing" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>ANSWER-3</h4>
                                <a href="https://drive.google.com/file/d/19Pk_1LOfesx6jhppN5lZ0vPxh8m1anPg/view?usp=sharing" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>ANSWER-4</h4>
                                <a href="https://drive.google.com/file/d/11PLgRH5jz_70jDz4Q3KcvAurrpl4f4fn/view?usp=sharing" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>ANSWER-5</h4>
                                <a href="https://drive.google.com/file/d/1I8COSPBB2JQSMm9l5gL5zm3MkPMW7Sek/view?usp=sharing" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
