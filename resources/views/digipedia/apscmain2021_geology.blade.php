...
<head>
    ...
    <!-- Title -->
    <title>DAY-2 GEOGRAPHY - Academy of Civil Services</title>
    <!-- Favicon -->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse " id="navbarCollapse">
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <li class="subnav">
                            <a href="#features">DAY-2 GEOGRAPHY</a>
                        </li>
                    </ul>
                </div>
                <!-- Menu Toogle end -->
            ...
            <div class="container">
                <div class="row">
                    <div class="lernen_banner_title">
                        <h1>DAY-2 GEOGRAPHY</h1>
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                <span class="first-item">
									<a href="/">Homepage</a></span>
                                <span class="separator">&gt;</span>
                                <span class="last-item">DAY-2 GEOGRAPHY</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h4 class="text-uppercase">APSC Previous Questions</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1hdAC-x1SYlWr1jcuLHfgYAtbjq3flBpP/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <!-- uses solid style -->
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4 class="text-uppercase">Study Material -1 </h4>
                                <a href="{{asset('https://drive.google.com/file/d/1Qgz9XnPUWvSxQ2qvo77uR0Ko4MD9YGTe/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <!-- uses solid style -->
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4 class="text-uppercase">Study Material -2</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1iCRUV7NhFMluAKtTQzAM30fpBunXnlbK/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <!-- uses solid style -->
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4 class="text-uppercase">Study Material -3</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1cIGizE3lW9s0kXW1JXIizekH0zAMx5Nl/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <!-- uses solid style -->
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4 class="text-uppercase">Study Material -4</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1U8x0mCxz_B2mtgXvOFpOb-_tLC4sm62n/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
