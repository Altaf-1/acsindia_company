...
<head>
    ...
    <!-- Title -->
    <title>Assam Tribune - Academy of Civil Services</title>
    <!-- Favicon -->
            ...
            <div class="container">
                <div class="row">
                    <div class="lernen_banner_title">
                        <h2 class="text-white">ASSAM TRIBUNE ANALYSIS</h2>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                            ...
                            <div class="single-features-light text-center">
                                ...
                                <div>
                                    ...
                                    <h4>{{$data->name}}</h4>
                                    <h3>{{$data->date}}</h3>
                                    <a href="{{asset('storage/'.$data->pdf)}}" class=" btn color-two button text-white">DOWNLOAD</a>
                                </div>
                            </div>
                            <!-- end single features -->
                        </div>
