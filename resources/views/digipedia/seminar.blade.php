...
@section('content')
    ...
    <main>
        ...
        <div id="carouselExampleIndicators">
			<div class="carousel-inner">
			    <div class="carousel-item active custom-slider"  >
			        <!--onclick="modal()"-->
				    <a>
				        <img class="d-block w-100 h-100" src="{{asset('comimages/seminar/s1.webp')}}" alt="First slide">
				    </a>
				</div>
			</div>
		</div>
        ...
        <div class="container text-center bg-dark pt-2 pb-2">
            <h4 class="text-white bg-dark">Date: 3rd SEP, 2023 (Sunday) | Time: 10.00a.m - 12.30p.m</h4>
            <h4 class="text-white bg-dark">Venue: Dibrugarh Branch | 9287958409 / 6000903039</h4>
        </div>
