                ...
                <div class="row justify-content-center">
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                ...
                                <h4>ECONOMY CURRENT AFFAIRS</h4>
                                <a href="https://drive.google.com/file/d/15sFKT6t1x1gcxrHuMiDweBOxAI3Xfw_W/view?usp=sharing" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>MIXED CURRENT AFFAIRS</h4>
                                <a href="https://drive.google.com/file/d/1WnFeIz7hsvKzTpTkPKS8_MC-7vSdfBXh/view?usp=sharing" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>ENVIRONMENT CURRENT AFFAIRS</h4>
                                <a href="https://drive.google.com/file/d/1HF6_1TRuiPWor2lRo2lI2_tVsaETjSHv/view?usp=sharing " class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
