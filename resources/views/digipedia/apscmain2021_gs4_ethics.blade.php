                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-5">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h4 class"text-uppercase">HUMAN VALUES</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1lflzDALdC0xbHMZJ_NOkEJ99eZQMcrSR/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                     <div class="col-xs-12 col-sm-12 col-md-4 col-lg-5">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <!-- uses solid style -->
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4 class"text-uppercase">Attitude</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1s_0kMmkvfyh1UFtnyFiTK-HZLRifoTFP/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
