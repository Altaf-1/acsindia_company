      ...
      <div>
            ...
            <div class="row ml-2 mr-2">
                ...
                @else
                    ...
                    <!-- APSC MAINS PYQ -->
                    @if ($course->title !== '90 DAYS BOOSTER COURSE (OFFLINE)' && $course->title != 'APSC 2023 INTERVIEW PREPARATION')
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 mt-3">
                            <div class="single-features-light text-center">
                                <!-- single features -->
                                <div>
                                    ...
                                    @if ($course->title == '20 DAYS FREE BOOSTER COURSE')
                                        <a disabled href="#"
                                            class=" btn btn-secondary text-white">UPGRADE</a>
                                    @else
                                        <a href="{{ route('user.apsc.pyq') }}"
                                            class=" btn color-two button text-white">View</a>
                                    @endif
                    ...
                    <div class="single-features-light text-center">
                        <div>
                            ...
                            <a href="{{ route('user.mock.test.material') }}" class=" btn color-two button text-white">View</a>
                        </div>
                    </div>
                </div>
