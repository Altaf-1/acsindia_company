            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse " id="navbarCollapse">
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <li class="subnav">
                            <a href="#features">Acs Materials</a>
                        </li>
                    </ul>
                </div>
                <!-- Menu Toogle end -->
                    ...
                    <div class="lernen_banner_title">
                        ...
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                ...
                                <span class="last-item">Acs Materials</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                ...
                                <h4>ESSAY PAPER</h4>
                                <a href="" class=" btn color-two button text-white disabled">UPCOMING</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>GS-1</h4>
                                <a href="/apscmain2021_gs-1" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 ">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>GS-2</h4>
                                <a href="/apscmain2021_gs-2" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>GS-3</h4>
                                <a href="/apscmain2021_gs-3" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 ">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>GS-4</h4>
                                <a href="/apscmain2021_gs-4" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 ">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>GS-5</h4>
                                <a href="/apscmain2021_gs-5" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
