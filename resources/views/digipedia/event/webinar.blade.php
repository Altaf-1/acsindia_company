...
<main>
			...
			<div class="col-lg-6">
				<div class="d-flex flex-column">
					...
					<div class="btn-section">
					    <a href="https://us06web.zoom.us/webinar/register/WN_aeUJ6U2nQoiD4OSQ2YVKsg" target="_blank" class="bg-primary text-center p-3 mt-2 pt-3 text-white">Book Now</a>
	...
	<!--			<div class="event-photo themeioan_event">-->
	<!--				<div class="date" style="background-color: #92089e;">-->
	<!--					<h4><span>27</span> Feb, 2022</h4>-->
	<!--				</div>-->
	<!--				<img src="{{asset('comimages/WORKSHOP.webp')}}" style="height: 450px; width: 100%;" alt="">-->
	<!--			</div>-->
	<!--		</div>-->
	<!--		<div class="col-lg-6">-->
	<!--			<div class="d-flex flex-column">-->
	<!--				<h2 class="text-center text-white" style="background-color: #129ea3; border-radius: 30px;">UPCOMING EVENTS</h2>-->
	<!--				<h3 class="text-center mt-4">3 DAYS WORKSHOP</h3>-->
	<!--				<table class="table bg-light mt-3 justify-content-center">-->
	<!--					<tbody>-->
	<!--						<tr>-->
	<!--							<td>Date</td>-->
	...
	<!--				</table>-->
	<!--				<div class="btn-section">-->
	<!--					<form action="{{route('webinar-registration.create',82285152983)}}">-->
	...
	<!--			<div class="d-flex flex-column">-->
	<!--				<h2 class="text-center text-white" style="background-color: #129ea3; border-radius: 30px;">UPCOMING EVENTS</h2>-->
	<!--				<h3 class="text-center mt-4">APSC WEBINAR</h3>-->
	<!--				<table class="table bg-light mt-3 justify-content-center">-->
	<!--					<tbody>-->
	<!--						<tr>-->
	<!--							<td>Date</td>-->
	...
	<!--				</table>-->
	<!--				<div class="btn-section">-->
	<!--					<form action="{{route('webinar-registration.create',85692487875)}}">-->
	<!--						<button type="submit" style="width:250px;">-->
	<!--							<span>Book Now</span>-->
	<!--							<div class="liquid"></div>-->
	<!--						</button>-->
	...
	<!--				</table>-->
	<!--				<div class="btn-section">-->
	<!--					<form action="{{route('webinar-registration.create',85972360307)}}">-->
	<!--						<button type="submit" style="width:250px;">-->
	<!--							<span>Book Now</span>-->
	<!--							<div class="liquid"></div>-->
	<!--						</button>-->
