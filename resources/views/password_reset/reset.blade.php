                ...
                <div class="card2 card border-0 px-4 py-5">
                    <form method="POST" action="{{route('password.change')}}">
                        ...
                        <div class="row mb-4 px-3">
                            <h3 class="mb-0 mr-4 mt-2 font-weight-bold">Enter new Password</h3>
                        </div>
                        ...
                        <div class="row px-3">
                            ...
                            <div class="row">
                                <div class="col-1">
                                    <input type="checkbox" class="text-white" id="passwordShow"
                                           onclick="myFunction()">  </div>
                                <label for="passwordShow">Show Password</label>
                        ...
                        <div class="row px-3">
                            ...
                            <div class="col-1">
                                <input type="checkbox" id="passwordShow1" class="text-white" onclick="myFunction2()">
                            </div>
                            <label for="passwordShow1">Show Password</label>
