                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                ...
                                <h4>ANSWER-1</h4>
                                <a href="https://drive.google.com/file/d/1B0QAzJmpn8c_bSczIu90yS04SMy7q52N/view?usp=sharing" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>ANSWER-2</h4>
                                <a href="https://drive.google.com/file/d/1bcaY-CUiUMmQLTbSZGHQe6lSg4sjsBeG/view?usp=sharing" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>ANSWER-3</h4>
                                <a href="https://drive.google.com/file/d/1wfiVto9EazHAVtew1WtKQYyAoX4_LUW7/view?usp=sharing" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
