...
<body>
    ...
    <main>
            ...
            <div class="container">
                <div class="row">
                    <div class="lernen_banner_title">
                        <h1 class="text-uppercase">KHADI PRAKRITHIK PAINT</h1>
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                <span class="first-item">
									<a href="/">Homepage</a></span>
                                <span class="separator">&gt;</span>
                                <span class="last-item">KHADI PRAKRITHIK PAINT</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="sigle-address ml-5 pt-2" aria-hidden="true">
            ...
            <h4 class="text-dark">It is India's first and only paint made from cow dung.</h4>
        </div>
        <div class="sigle-address ml-5" aria-hidden="true">
            <div class="address-icon" >
                <i class="fa fa-circle text-dark"></i>
            </div>
            <h4 class="text-dark">It was developed by Khadi and Village Industries Commission (KVIC).</h4>
        </div>
        <div class="sigle-address ml-5" aria-hidden="true">
            <div class="address-icon" >
                <i class="fa fa-circle text-dark"></i>
            </div>
            <h4 class="text-dark">It is inspired from the age-old Indian tradition of coating the walls and floor of the houses with cow dung.</h4>
        </div>
        <div class="sigle-address ml-5" aria-hidden="true">
            <div class="address-icon" >
                <i class="fa fa-circle text-dark"></i>
            </div>
            <h4 class="text-dark">It conforms to BIS standards.</h4>
        </div>
        </div>
        <div class="sigle-address ml-5" aria-hidden="true">
            <div class="address-icon" >
            ...
            <h4 class="text-dark">Available in two forms - distemper paint and plastic emulsion paint.</h4>
        </div>
        <div class="sigle-address ml-5" aria-hidden="true">
            <div class="address-icon" >
                <i class="fa fa-circle text-dark"></i>
            </div>
            <h4 class="text-dark">The paint is washable, waterproof, and durable and dries quickly in just 4 hours.</h4>
        </div>
