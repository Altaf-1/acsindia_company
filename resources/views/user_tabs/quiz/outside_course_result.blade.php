    ...
    <main>
        ...
        @if ($course_name == 'Probable Question')
            <div class="text-center pt-3 pb-3 bg-dark">
                <h3 class="text-white">Enroll our latest Test Series for Target 2024 prelims   <span><a href="https://acsindiaias.com/apsc/course/58" class="bg-danger text-white p-2 rounded">Click Here</a></span></h3>
        </div>
        @endif
    </div>
                        ...
                        @foreach ($datas as $data)
                            <div class="col-sm-12">
                                <div class="single-features-light mt-3">
                                    <div>
                                        <h4 id="question">{{ $loop->index + 1 }}. {!! $data->question !!}</h4>
                                        <div
                                            class="form-group {{ $data->option1 === $data->correct_option ? 'bg-warning' : '' }} p-2">
                                            <input {{ $data->option1 == $data->correct_option ? 'checked' : '' }} disabled
                                                type="radio" name="answers{{ $loop->index }}"
                                        ...
                                        <div
                                            class="form-group {{ $data->option2 === $data->correct_option ? 'bg-warning' : '' }} p-2">
                                            <input {{ $data->option2 == $data->correct_option ? 'checked' : '' }} disabled
                                                type="radio" name="answers{{ $loop->index }}"
                                        ...
                                        <div
                                            class="form-group {{ $data->option3 === $data->correct_option ? 'bg-warning' : '' }} p-2">
                                            <input {{ $data->option3 == $data->correct_option ? 'checked' : '' }} disabled
                                                type="radio" name="answers{{ $loop->index }}"
                                        ...
                                        <div
                                            class="form-group {{ $data->option4 === $data->correct_option ? 'bg-warning' : '' }} p-2">
                                            <input {{ $data->option4 == $data->correct_option ? 'checked' : '' }} disabled
                                                type="radio" name="answers{{ $loop->index }}"
                                        ...
                                        <div
                                            class="form-group text-white p-2 {{ $data->answer == $data->correct_option ? 'bg-success' : 'bg-danger' }}">
                                            <label for="">
                                                {{ $data->answer == $data->correct_option ? 'Correct' : 'Wrong' }}</label>
                                        </div>
