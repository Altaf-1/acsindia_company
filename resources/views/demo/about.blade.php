...
<main>
   ...
   <div><img src="{{asset('comimages/head/u11.png')}}" class="img-fluid d-block w-100 h-100"></div>
        ...
        <div class="container">
            <div class="kobolg-popupvideo style-01">
                <div class="popupvideo-inner">
                    <div class="icon">
                        <img src="{{ asset('comimages/2023/aboutus.webp') }}"
                             class="attachment-full size-full"/>
                        
                    </div>
                    <div class="popupvideo-wrap" style="margin-top: 0px; padding-top: 0px;">
                        <h2 class="pl-5" style="font-size: 40px; font-family: 'Righteous'; background-color: #e52e06; color: white; !important">
                            VISION & MISSION </h2>
                        <p style="font-size: 20px; font-family: 'Righteous'; color: black;">Aspirations of Academy of Civil Services move hand in hand with the Indian Civil Services Aspirants.
                            Success of each aspirant is our priority. We believe in pure ethical form of service, with zero tolerance in quality
                            learning at an affordable price for each fellow Indian.</p>
                        <p style="font-size: 20px; font-family: 'Righteous'; color: black;">Our each session starts with a mission to promote smart work, patience and perseverance among the students.
                             We pledge to give guidance to our aspirants till they land in success.</p>
                    </div>
                    </div>
                </div>
            </div>
   ...
   <div class="container mt-3 mb-5 pt-3 pb-3" style="background-color: #134982">
       <div class="row">
           <div class="col-lg-4">
               <h2 class="pt-3 pb-3 text-white text-center" style="font-family: 'Righteous';">Visit Our Online Channels</h2>
               <div class=row>
                   <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4"> <a href="https://www.facebook.com/acs.iasindia">
   <img src="{{asset("comimages/social/fb.png")}}" style="height: 60px;"/>
   </a></div>
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4"><a href="https://www.instagram.com/academyofcivilservices/">
   <img src="{{asset("comimages/social/insta.png")}}" style="height: 60px;"/>
   </a></div>
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4"><a href="https://t.me/acsias">
   <img src="{{asset("comimages/social/tel.png")}}" style="height: 60px;"/>
   </a></div>
               </div>
               <div class="d-grid gap-2 d-md-flex justify-content-md-center">
   <a class="btn mt-5 text-center text-white" style="background-color: #e52e06"  href="https://www.youtube.com/channel/UCOs-olyxhFwKLyz353n5kgw" style="font-family: 'Righteous';">View All Videos</a>
   </div>
           </div>
           <div class="col-lg-7 d-flex justify-content-center">
               <div class="row d-flex justify-content-center">
                  <div class="col-lg-4 col-sm-12 col-xs-12"><div class="p-2">
                      <div class="card" style="width: 18rem;">
   <img src="{{asset("comimages/social/ar.png")}}" class="card-img-top" alt="...">
   <div class="card-body text-center">
   <h5 class="card-title">Artificial Intelligence</h5>
   <a href="https://youtu.be/tVyNDJqndYQ" class="btn btn-danger" style="background-color: #e52e06">View</a>
   </div>
   </div>
                  </div></div>
                  <div class="col-lg-4 col-sm-12 col-xs-12"><div class="p-2"><div class="card" style="width: 18rem;">
   <img src="{{asset("comimages/social/y2.png")}}" class="card-img-top" alt="...">
   <div class="card-body text-center">
   <h5 class="card-title">Federal System in India</h5>
   <a href="https://youtu.be/-tOVufeXdFs" class="btn btn-danger" style="background-color: #e52e06">View</a>
   </div>
   </div></div></div>
   ...
   <a href="https://youtu.be/pevfbMSBXuw" class="btn btn-danger" style="background-color: #e52e06">View</a>
   </div>
   </div></div></div>
      ...
      <div style="background-color: #cc3d1e">
         ...
         <div class="row pl-4 pr-4 justify-content-center">
            <div class="col-lg-12 col-sm-12">
               <div>
                  <p><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3539.4851596283424!2d94.91970161425219!3d27.48528324182426!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x37409869cb35768d%3A0x491ce8fdcae8360a!2sAcademy%20Of%20Civil%20Services!5e0!3m2!1sen!2sin!4v1641360136814!5m2!1sen!2sin" width="1200" height="400" style="border:2px solid black;" allowfullscreen="" loading="lazy"></iframe></p>
               </div>
            </div>
         </div>
         <div class="m-0">
            <div class="row" >
               <div class="col-lg-4 col-sm-12">
                  <div class="d-flex flex-row">
                     ...
                     <h3 style="padding-top: 25px; padding-left: 20px; color: #fff;">9287958404</h3>
                  </div>
               </div>
               <div class="col-lg-4 col-sm-12">
                  <div class="d-flex flex-row">
