    ...
    <main>
            ...
            <div class="container">
                <div class="row">
                    <div class="lernen_banner_title">
                        <h1 class="text-uppercase">BAIL (Legal Term Mentioned in the News) </h1>
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                <span class="first-item">
									<a href="/">Homepage</a></span>
                                <span class="separator">&gt;</span>
                                <span class="last-item">BAIL (Legal Term Mentioned in the News)</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="pt-4">
            <div class="sigle-address pt-2" aria-hidden="true">
                ...
                <h3 ><strong>Definition and Meaning:</strong></h3>
            </div>
        <div class="sigle-address ml-5 pt-2" aria-hidden="true">
            <div class="address-icon" >
                <i class="fa fa-circle text-dark"></i>
            </div>
            <h4 class="text-dark">‘Bail’ is derived from the old French verb ‘baillier’ meaning to ‘give or deliver’.</h4>
        </div>
         ...
         <div class="sigle-address ml-5 pt-2" aria-hidden="true">
            ...
            <h4 class="text-dark">The term bail has not been defined in the Criminal Procedure Code.  The word has been used in the Cr.P.C. several times and remains one of the most vital concepts of the criminal justice system.</h4>
        </div>
        ...
        <div class="sigle-address ml-3 pt-2" aria-hidden="true">
            ...
            <h4 class="text-dark">Setting free of the defendant by releasing him/her from the custody of law and entrusting him/her to the custody of his/her sureties who are liable to produce him/her to appear for trial at a specific date and time.</h4>
        </div>
