...
<html lang="zxx">
    <head> 
        <!-- meta tag -->
        <meta charset="utf-8">
        <title>Best Apsc Coaching In Assam</title>
                            ...
                            <div class="col-lg-5">
                                <div class="logo-cat-wrap">
                                    <div class="logo-part pr-90">
                                        <a class="dark-logo" href="https://www.acsindiaias.com">
                                            <h2 class="mt-4">ACS</h2>
                                        </a>
                                        <a class="light-logo" href="https://www.acsindiaias.com">
                                            <h2 class="mt-4 text-white">ACS</h2>
                                    ...
                                    <div class="main-menu pr-90">
                                        <div class="mobile-menu">
                                            <a class="rs-menu-toggle">
                                                ...
                                                <i class="display-2" aria-hidden="true">=</i>
                                            </a>
                                        </div>
                                        <nav class="rs-menu">
                                           <ul class="nav-menu">
                                              <li class=""> <a href="https://www.acsindiaias.com">Home</a>
                                              </li>
                                              <li class=""> <a href="https://www.acsindiaias.com/apsc">APSC WEBSITE</a>
                                              </li>
                                           </ul>
                                        </nav>
                                    </div> <!-- //.main-menu -->
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay">
                <div class="breadcrumbs-img">
                    <img class="p-0 m-0" src="{{asset('comimages/apsc/about-1.jpg')}}" alt="Breadcrumbs Image">
                </div>
                <div class="breadcrumbs-text white-color">
                    <h1 class="page-title">PRIME SESSION</h1>
                    <ul>
                        <li>
        ...
        <div id="features" class="wrap-bg">
            ...
            <div class="container">
                <div>
                    ...
                    <h4>The first session or the first class or the first day’s session of every month is called a Prime Session.</h4>
                </div>
                <div class="mt-4">
                    <div class="address-icon" >
                        <i class="fa fa-circle text-dark"></i>
                    </div>
                    <h4>The objective of the session is to priorities the content according to the demand of the examinations.</h4>
                </div>
                <div class="mt-4">
                    <div class="address-icon" >
                        <i class="fa fa-circle text-dark"></i>
                    </div>
                    <h4>It can be a special session on a major module of a particular subject like Polity or Economy, where more questions have been asked repeatedly in the previous years.</h4>
                </div>
                <div class="mt-4">
                    <div class="address-icon" >
                        <i class="fa fa-circle text-dark"></i>
                    </div>
                    <h4>It can be a session on the most important current affairs of the previous month or the old current affairs.</h4>
                </div>
                <div class="mt-4">
                    <div class="address-icon" >
                        <i class="fa fa-circle text-dark"></i>
                    </div>
                    <h4>The current affairs topics will be selected according to the relevance and also by expecting the questions for the upcoming Prelims or Mains examinations.</h4>
                </div>
                <div class="mt-4">
                    <div class="address-icon" >
                        <i class="fa fa-circle text-dark"></i>
                    </div>
                    <h4>The Prime Session will be the beginning of the following session that will be taking in the coming days or weeks.</h4>
                </div>
                <div class="mt-5">
				<img style="width: 800px; height: 470px; border-radius: 35px; box-shadow: 5px 10px 8px 10px #888888;" src="{{ asset('comimages/head/Prime.PNG')}}">
			</div>
            </div>
                <!-- .row end -->
            </div>
