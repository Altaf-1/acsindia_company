                    ...
                    <div class="lernen_banner_title">
                        ...
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                ...
                                <span class="last-item">APSC Course</span>
                            </div>
                        </div>
                    </div>
                </div>
...
{{--                                        <li><i class="fas fa-check-circle"></i> PDF study plans.</li>--}}
{{--                                        <li><i class="fas fa-check-circle"></i> 30 prelims model test.</li>--}}
{{--                                        <li><i class="fas fa-check-circle"></i> Current affairs updates.</li>--}}
{{--                                        <li><i class="fas fa-check-circle"></i> Free main online coaching.</li>--}}
{{--                                        <li><i class="fas fa-check-circle"></i> Free interview guidance.</li>--}}
                                    </ul>
                                    <hr>
                                    ...
                                    <div class="row course-end mt-1">
                                            ...
                                            <div class="container mt-2">
                                                ...
                                                <form action="{{route('user.extra_material.add_remove_material')}}"
                                                    ...
                                                    <div class="form-group font-weight-bold">
                                                        <label for="course_1" class="text-white material-label">UPSC Material ( ₹ 2000 ):</label>
                                                        <input type="checkbox"
                                                               class="check-form"
                                                               @if(\App\UserExtraMaterial::check_material_exists($course->course_id, $course->id, 1))
                                                                   checked
                                                               @endif
                                                               name="course_1">

                                                        <label for="course_1" class="text-white material-label">APSC Material ( ₹ 2000 ):</label>
                                                        <input type="checkbox"
                                                               class="check-form"
                                                               @if(\App\UserExtraMaterial::check_material_exists($course->course_id, $course->id, 2))
                                                                   checked
                                                               @endif
                                                               name="course_2">

                                                        <label for="no_material" class="text-white material-label">No Material ( ₹ 0 ):</label>
                                                        <input type="checkbox"
                                                               class="check-form"
                                                               @if(\App\UserExtraMaterial::check_material_exists($course->course_id, $course->id, 3))
                                                                   checked
                                                               @endif
                                                               name="no_material">
                                        ...
                                        <div class="col-sm-6  text-white mobile p-4 ">
                                            <div>
                                                <del><h5 class="text-danger">₹ 23,600</h5></del>
                                                @if($coupon == null)
                                                    <h4 class="text-white">Price
                                                        : ₹ {{$course->price + \App\UserExtraMaterial::get_total_amount($course->course_id, $course->id)}}</h4>
                                                @elseif($coupon->applied == 1)
                                                    <h4 class="text-white">Price
                                                        : ₹ {{$course->sale + \App\UserExtraMaterial::get_total_amount($course->course_id, $course->id)}}</h4>
                                                @else
                                                    <h4 class="text-white">Price
                                                        : ₹ {{$course->price + \App\UserExtraMaterial::get_total_amount($course->course_id, $course->id)}}</h4>
                                                @endif
                                        ...
                                        <div class="container mt-2">
                                    <h6 class="text-white">Please apply your coupon before buying the course.</h6></div>
                                    </div>
                                </div>
                            </article>
                            <!-- end single course -->
