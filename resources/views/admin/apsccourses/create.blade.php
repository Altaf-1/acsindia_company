...
@section('content')
    ...
    <div class="container emp-profile mt-3">
        <form action="{{ route('admin.apsccourses.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group font-weight-bold">
                ...
                <textarea class="form-control" name="options" PLACEHOLDER="<li><i class='fas fa-check-circle'></i> Daily Q&A session.</li>"></textarea>
            </div>
            <div class="form-group font-weight-bold">
