...
@section('content')
    ...
    <div class="container emp-profile mt-3">
        <form action="{{ route('admin.testseriesquizroll.update', $data->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('patch')
            ...
            <div class="form-group font-weight-bold">
                ...
                <input type="file" style="border-radius: 20px;" value="{{ old('pdf') }}"
