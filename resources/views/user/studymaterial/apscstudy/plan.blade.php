                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h4>ECONOMY</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1ekgCZGbUgiYNC-iw-Ku37nUQwNdyf1c_/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4>GEOGRAPHY</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1-68__AhMohREbeQ9A55SD64mjsO3XY-l/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4>HISTORY</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1wcVsqbq4LKCFafi0S9xzMWT1mVUDPurI/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4>POLITY</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1qpDfIPOZe6CwIzZJk_aMqQGehVTk3ILq/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <a href="{{asset('https://drive.google.com/file/d/1d-QT5bUj5Yuzz425fuQp6YfWd20OntmA/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4>ASSAM</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1MyK3--H0LdjmmXo9rEGgyMw5NKBthgfV/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
