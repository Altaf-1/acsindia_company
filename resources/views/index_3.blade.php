		...
		<div id="carouselExampleIndicators" class="carousel slide mt-3" data-ride="carousel">
			<div class="carousel-inner">
			    <div class="carousel-item active custom-slider">
					<a href="">
				        <img class="d-block w-100 h-100" src="{{asset('comimages/2023/head/2.webp')}}" alt="First slide">
				    </a>
				</div>
			    <div class="carousel-item custom-slider">
				    <a href="">
				        <img class="d-block w-100 h-100" src="{{asset('comimages/2023/apsc-1.webp')}}" alt="First slide">
				    </a>
				</div>
			</div>
   ...
   <div class="rs-faq-part style1 pb-100 md-pt-70 md-pb-70 mt-2">
                <div class="container-fluid m-2">
                        ...
                        <div class="col-lg-6 padding-0 about-intro">
                          <div class="main-part">
                            <div class="title mb-40 md-mb-15 mb-5">
                                <h2 class="text-part text-white text-center mt-5" style="background-color: #e52e06; font-family: 'Righteous';">OUR COURSE DETAILS</h2>
                            </div>
                              <div class="row">
					<div class="col-lg-6 col-sm-6 col-md-6 text-center justify-content-center">
									...
									<a href="https://acsindiaias.com/apsc/courses" class="shadow_1 d-flex flex-column text-white p-2 rounded-pill mb-2" style="background-color: #134982; font-family: 'Righteous';">Online Courses</a>
									</div>
					<div class="col-lg-6 col-sm-6 col-md-6 text-center justify-content-center">
									<img class="text-danger p-1 mb-4" style="width:110px; boder: 1px solid black; border-radius: 20px;" src="{{asset('comimages/icons/d5.png')}}">
									...
									<a href="https://acsindiaias.com/offline" class="shadow_1 d-flex flex-column text-white p-2 rounded-pill mb-2" style="background-color: #134982; font-family: 'Righteous';">Offline Courses</a>
									</div>
									<div class="col-lg-6 col-sm-6 col-md-6 text-center justify-content-center">
									...
									<a href="https://acsindiaias.com/upsc_recorded_course" class="shadow_1 d-flex flex-column text-white p-2 rounded-pill mb-2" style="background-color: #134982; font-family: 'Righteous';">Reorded Courses</a>
									</div>
									<div class="col-lg-6 col-sm-6 col-md-6 text-center justify-content-center">
									...
									<a href="{{route('dailynewsanalyse.index')}}" class="shadow_1 d-flex flex-column text-white p-2 rounded-pill mb-2" style="background-color: #134982; font-family: 'Righteous';">Daily News</a>
									</div>
									<div class="col-lg-6 col-sm-6 col-md-6 text-center justify-content-center">
									...
									<a href="/current_affairs_2023" class="shadow_1 d-flex flex-column text-white p-2 rounded-pill mb-2" style="background-color: #134982; font-family: 'Righteous';">Current Affairs</a>
									</div>
									<div class="col-lg-6 col-sm-6 col-md-6 text-center justify-content-center">
									<img class="text-danger p-1 mb-4" style="width:130px; boder: 1px solid black; border-radius: 20px;" src="{{asset('comimages/icons/cr.png')}}">
									...
									<a href="https://acsindiaias.com/acsall" class="shadow_1 d-flex flex-column text-white p-2 rounded-pill mb-2" style="background-color: #134982; font-family: 'Righteous';">ACS Degipedia</a>
									</div>
            ...
            <div id="rank" class="rs-blog main-home md-pt-10 md-pb-70">
                <div class="text-center mb-5">
                        <h1 class="text-white text-center pt-3 pb-3" style="background-color: #e52e06; font-family: 'Righteous';"> OUR APSC RESULTS</h1>
                      </div>
                <div class="container">  
                    <div class="row">
                        <div class="col-lg-6 mt-3">
                            <img src="{{asset('comimages/apsc/result_n.png')}}" style="height: 550px" class="img-fluid" alt="Responsive image">
                        </div>
                        <div class="col-lg-6 mt-3">
                            <img src="{{asset('comimages/head/topm.png')}}" style="height: 550px" class="img-fluid" alt="Responsive image">
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div class="container pb-4">
         <div class="row justify-content-center pb-3 pt-5 pb-5">
            <div class="col-md-8 text-center heading-section">
               <h2 class="mb-4 text-uppercase text-white" style="background-color: #e52e06; font-family: 'Righteous';">Upcoming Events</h2>
            </div>
         </div>
         <div class="row">
                  ...
                  <div class="col-lg-7">
                     <div class="course-info">
                        ...
                        <div class="bottom-part">
                           ...
                           <div class="btn-part">
                              <a href="/acs_seminar"
                                 class="btn text-white font-weight-bold mb-4" style="background-color: #e52e06;">Apply Now<i
