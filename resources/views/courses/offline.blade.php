...
<main>
    ...
    <div>
    	<!--Offline Courses -->
	<!-- Faq Section Start -->
  <!--          <div id="plan" class="container-fluid p-0 mb-4">-->
			
		<!--	<div class="container-fluid p-4">-->
		<!--	    <div class="row">-->
		<!--	 <div class="col-lg-4">-->
		<!--		<div class="event-photo themeioan_event">-->
		<!--			<img src="{{asset('comimages/2.png')}}" style="height: 400px; width: 100%;" alt="">-->
		<!--		</div>-->
		<!--	</div>-->
		<!--	<div class="col-lg-4">-->
		<!--		<div class="event-photo themeioan_event">-->
  <!--                  <a href="https://www.acsindiaias.com/apsc/course/22"><img src="{{asset('comimages/off-2.png')}}" style="height: 400px; width: 100%;" alt=""></a>-->
		<!--		</div>-->
		<!--	</div>-->
		<!--	<div class="col-lg-4">-->
		<!--		<div class="event-photo themeioan_event">-->
  <!--                  <a href="https://www.acsindiaias.com/apsc/course/24"><img src="{{asset('comimages/off-1.png')}}" style="height: 400px; width: 100%;" alt=""></a>-->
		<!--		</div>-->
		<!--	</div>-->
                            ...
                            <div class="notice-bord style1">
                                <ul>
                                    <li class="wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                                        <div class="desc">Morning Batch (7 am to 9 am) -> New Batch Start From 17 April 2023.</div>
                                    </li>
