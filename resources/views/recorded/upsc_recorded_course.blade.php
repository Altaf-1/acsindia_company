                            ...
                            <div class="themeioan_course">
                                <article>
                                    ...
                                    <div class="blog-content">
                                        <h5 class="title text-center">ECOLOGY & ENVIRONMENT(UPSC)</h5>
                                        <ul class="course-bottom-list justify-content-end">
                                            <li>
                                                <div class="course-duration">
                                                    <span class="fa fa-clock-o"></span>
                                                    <a href="https://acsindiaias.com/user/study/show/23"
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 p-0 course-animation course-single mb20">
                            ...
                            <div class="themeioan_course">
                                <article>
                                    ...
                                    <div class="blog-content">
                                        <h5 class="title text-center">INDIAN ECONOMY(UPSC)</h5>
                                        <ul class="course-bottom-list justify-content-end">
                                            <li>
                                                <div class="course-duration">
                                                    <span class="fa fa-clock-o"></span>
                                                    <a href="https://acsindiaias.com/user/study/show/24"
                                                       class=" btn color-two button text-white">Know More</a>
                                                </div>
                                            </li>
                                        </ul>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 p-0 course-animation course-single mb20">
                            ...
                            <div class="themeioan_course">
                                <article>
                                    ...
                                    <div class="blog-content">
                                        <h5 class="title text-center">GEOGRAPHY(UPSC)</h5>
                                        <ul class="course-bottom-list justify-content-end">
                                            <li>
                                                <div class="course-duration">
                                                    <span class="fa fa-clock-o"></span>
                                                    <a href="https://acsindiaias.com/user/study/show/22"
                                                       class=" btn color-two button text-white">Know More</a>
                                                </div>
                                            </li>
                                        </ul>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 p-0 course-animation course-single mb20">
                            ...
                            <div class="themeioan_course">
                                <article>
                                    ...
                                    <div class="blog-content">
                                        <h5 class="title text-center">INDIAN HISTORY, ART & CULTURE(UPSC)</h5>
                                        <ul class="course-bottom-list justify-content-end">
                                            <li>
                                                <div class="course-duration">
                                                    <span class="fa fa-clock-o"></span>
                                                    <a href="https://acsindiaias.com/user/study/show/25"
                                                       class=" btn color-two button text-white">Know More</a>
                                                </div>
                                            </li>
                                        </ul>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 p-0 course-animation course-single mb20">
                            ...
                            <div class="themeioan_course">
                                <article>
                                    ...
                                    <div class="blog-content">
                                        <h5 class="title text-center">SCIENCE & TECHNOLOGY(UPSC)</h5>
                                        <ul class="course-bottom-list justify-content-end">
                                            <li>
                                                <div class="course-duration">
                                                    <span class="fa fa-clock-o"></span>
                                                    <a href="https://acsindiaias.com/user/study/show/21"
                                                       class=" btn color-two button text-white">Know More</a>
                                                </div>
                                            </li>
                                        </ul>
