...
<head>
    ...
    <!-- Title -->
    <title>TEST CENTER - Academy of Civil Services</title>
    <!-- Favicon -->
...
<main>
        ...
        <div class="container">
            <div class="row">
                <div class="lernen_banner_title">
                    <h2 class="text-white">TEST CENTER</h2>
    ...
    <!-- contact area start -->
    <div id="features" class="wrap-bg bg-light">
        <!-- .container -->
        <div class="container">
            <!-- .row -->
            <div class="container">
                    ...
                    @foreach($tests as $test)
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            ...
                            <div class="single-features-light text-center">
                                <!-- single features -->
                                <div>
                                    <i class="base-color fab fa-leanpub fa-5x"></i>
                                    <h4>TEST TITLE : {{$test->title}}</h4>
                                    <h4>DATE : {{\Carbon\Carbon::create($test->date)->format('d-M-Y')}}</h4>
                                    <h4>Duration : {{$test->duration}}</h4>
                                    <h4>Total Marks : {{$test->total_marks}}</h4>
                                    <h4>{{$test->note}}&nbsp;</h4>
                                    <a href="{{$test->link}}"  class="disabled btn color-two button text-white">ENTER</a>
                                </div>
                            </div>
                            <!-- end single features -->
                        </div>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="icon-round-white footer-social mt-25">
                        ...
                        <a href="https://www.instagram.com/academyofcivilservices" title="Instagram" target="_blank"><i
