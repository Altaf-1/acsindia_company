...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse " id="navbarCollapse">
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <li class="subnav">
                            <a href="#features">V SHAPED ECONOMIC RECOVERY</a>
                        </li>
                    </ul>
                </div>
                <!-- Menu Toogle end -->
    ...
    <main>
            ...
            <div class="container">
                <div class="row">
                    <div class="lernen_banner_title">
                        <h1 class="text-uppercase">V SHAPED ECONOMIC RECOVERY</h1>
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                <span class="first-item">
									<a href="/">Homepage</a></span>
                                <span class="separator">&gt;</span>
                                <span class="last-item">V SHAPED ECONOMIC RECOVERY</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="sigle-address ml-5 pt-2" aria-hidden="true">
            ...
            <h4 class="text-dark">The V-shaped economic recovery means quick and sustained recovery in measures of economic performance after a sharp economic decline.</h4>
        </div>
        <div class="sigle-address ml-5" aria-hidden="true">
            <div class="address-icon" >
                <i class="fa fa-circle text-dark"></i>
            </div>
            <h4 class="text-dark">Specifically, a V-shaped recovery represents the shape of a chart of economic measures economists create when examining recessions and recoveries.</h4>
        </div>
        <div class="sigle-address ml-5" aria-hidden="true">
            <div class="address-icon" >
                <i class="fa fa-circle text-dark"></i>
            </div>
            <h4 class="text-dark">A V-shaped recovery involves a sharp rise back to a previous peak after a sharp decline in these metrics.</h4>
        </div>
        <div class="sigle-address ml-5" aria-hidden="true">
            <div class="address-icon" >
                <i class="fa fa-circle text-dark"></i>
            </div>
            <h4 class="text-dark">The recoveries that followed the recessions of 1920-21 and 1953 in the U.S. are examples of V-shaped recoveries.</h4>
        </div>
        <div class="ml-5 pt-2 pb-3">
                                            
            <img src="{{asset('comimages/vshape.jpg')}}" alt="" width="800" height="400">
        </div>
