                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h4>PHYSICS</h4>
                                <a href="/phy-sub" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>CHEMISTRY</h4>
                                <a href="/che-sub" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 ">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>BIOLOGY</h4>
                                <a href="https://drive.google.com/file/d/1Tdk9qGCPbskxTjobUFd6_BYEfaEgW6TR/view?usp=sharing" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
