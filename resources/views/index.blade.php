...
<!-- meta tag -->
    ...
    <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'AW-411743661'); </script>
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8391119276578244"
     crossorigin="anonymous"></script>
    
    <script> gtag('config', 'AW-411743661/VaRACJu54csYEK3rqsQB', { 'phone_conversion_number': '06000505707' }); </script>
                    ...
                    <div class="slide-info">
                        <div class="container">
                            <div class="slide-inner">
                                ...
                                <a href="{{route('free.trial.course')}}" class="shadow_2 mt-3" style="background-color: #134982; font-family: 'Righteous';">JOIN DEMO CLASS</a><br/>
                                <a href="https://acsindiaias.com/recorded/course/ias-workshop" class="shadow_2 mt-3" style="background-color: #134982; font-family: 'Righteous';">IAS WORKSHOP</a><sup class="text-white bg-danger p-3 ml-2 rounded-circle vert-move">NEW</sup>
                                <!--<a href="{{ route('user.course.view', [$apsc_interview_course, 'APSC']) }}" class="shadow_2 mt-3" style="background-color: #134982; font-family: 'Righteous';">APSC 2023 INTERVIEW PREPARATION</a><sup class="text-white bg-danger p-3 ml-2 rounded-circle vert-move">NEW</sup>-->
                                <!--<a href="/dailynewsanalyse" class="shadow_2 mt-3" style="background-color: #134982; font-family: 'Righteous';">TODAY'S NEWS ANALYSIS</a>-->
                    ...
                    <div class="slide-info">
                        <div class="container">
                            <div class="slide-inner">
                                ...
                                <h5>Online/Offline</h5>
                                <h5><spam><i class="fa fa-phone fa-phone-top"></i> </spam> 6000505707</h5>
                                <a href="{{route('free.trial.course')}}" class="shadow_2 mt-3" style="background-color: #134982; font-family: 'Righteous';">JOIN DEMO CLASS</a><br/>
                                <a href="{{ route('user.course.view', [$apsc_interview_course, 'APSC']) }}" class="shadow_2 mt-3" style="background-color: #134982; font-family: 'Righteous';">APSC 2023 INTERVIEW PREPARATION</a><sup class="text-white bg-danger p-3 ml-2 rounded-circle">NEW</sup>
                                <!--<a href="/dailynewsanalyse" class="shadow_2 mt-3" style="background-color: #134982; font-family: 'Righteous';">TODAY'S NEWS ANALYSIS</a>-->
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="banner-info " style="text-align: center;">
                                <div class="banner-content">
                                    <div class="title-wrap">
                                        <h6 class="title" style="font-weight: bold; font-family: 'Righteous';">UPSC </h6><br>
                                        <h6 class="title" style="font-weight: bold; font-family: 'Righteous';">PREPARATION</h6>
                                    </div>
                                    <div class="cate">
                                        ONLINE / OFFLINE CLASSES
                                    </div>
                                    <div class="button-wrap">
                                        <a class="button shadow_2" target="_self" href="https://acsindiaias.com/upsc" style="background-color: #e52e06; font-family: 'Righteous';"><span>View Details</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="kobolg-banner style-09 left-center">
                        <div class="banner-inner">
                            ...
                            <div class="banner-info " style="text-align: center;">
                                <div class="banner-content">
                                    <div class="title-wrap">
                                        <h6 class="title" style="font-weight: bold; font-family: 'Righteous';">APSC </h6><br>
                                        <h6 class="title" style="font-weight: bold; font-family: 'Righteous';">PREPARATION</h6>
                                    </div>
                                    <div class="cate">
                                        ONLINE / OFFLINE CLASSES
                                    ...
                                    <div class="button-wrap">
                                        <a class="button shadow_2" target="_self" href="https://acsindiaias.com/apsc" style="background-color: #e52e06; font-family: 'Righteous';"><span>View Details</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="kobolg-banner style-10 left-center">
                        <div class="banner-inner">
                            ...
                            <div class="banner-info " style="text-align: center;">
                                <div class="banner-content">
                                    <div class="title-wrap">
                                        <h6 class="title" style="font-weight: bold; font-family: 'Righteous';">SELF </h6><br>
                                    ...
                                    <div class="button-wrap">
                                        <a class="button shadow_2" target="_self" href="https://acsindiaias.com/self-study" style="background-color: #e52e06; font-family: 'Righteous';"><span>View Details</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="d-flex flex-column">
					...
					<h3 class="text-center mt-4 text-white" style="background-color: #129ea3; border-radius: 30px;">IAS WEBINAR</h3>
					...
					<div class="btn-section">
					    <a href="https://acsindiaias.com/recorded/course/ias-workshop" target="_blank" class="bg-primary text-center p-3 mt-5 pt-3 text-white">Book Now</a>
                     ...
                     <div class="py-md-5">
                        ...
                        <form method="get" action="{{route('query')}}" class="appointment-form">
                            ...
                            <div class="d-md-flex">
                                ...
                                <div class="form-group ml-md-4">
                                    <input type="submit" value="Submit" class="btn py-7 px-7 shadow_2" style="background-color: #e52e06; font-family: 'Righteous';">
                                </div>
                            </div>
                        </form>
                    </div>
