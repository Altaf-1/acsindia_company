    ...
    @if ($message = Session::get('success'))
        <script>
            ...
            element.setAttribute('href',
                '{{ asset('storage/' . Session::get('link')) }}');
            element.setAttribute('download', 'ExamPdf');
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 mb-4 ">
                                <div class="single-features-light text-center bg-light">
                                    <div>
                                        ...
                                        <a target="_blank"
                                            href="{{ route('online.quiz.questions', [$data->online_quiz_id, $data->course_name]) }}"
                                            class="btn color-two button text-white">Take Test</a>
                                        {{-- @if ($data->user_attempt_left($data->quiz->id))
                                          
                                        @else
                                            No Attempt Left <br>
                                            <a href="{{ route('online.quiz.result.view', ['id' => $data->quiz_id, 'user_id' => Auth::user()->id]) }}"
