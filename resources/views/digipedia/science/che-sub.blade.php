                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h4>PART-1</h4>
                                <a href="https://drive.google.com/file/d/1q1h51cCChS6_F7n4hngKYIT4tvRxQbge/view?usp=sharing" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>PART-2</h4>
                                <a href="https://drive.google.com/file/d/1VUvDN7XVYXQqLUXDQBIdfuiVaCnfQk0F/view?usp=sharing" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
