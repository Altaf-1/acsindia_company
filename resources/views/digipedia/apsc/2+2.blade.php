        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay">
                ...
                <div class="breadcrumbs-text white-color">
                    <h1 class="page-title">2+2 SESSION</h1>
                    <ul>
                        <li>
        ...
        <div id="features" class="wrap-bg">
            ...
            <div class="container">
                <div>
                    ...
                    <h4>The second day of the second week class will be called as 2+2 Session.</h4>
                </div>
                <div class="mt-4">
                    <div class="address-icon" >
                        <i class="fa fa-circle text-dark"></i>
                    </div>
                    <h4>The session will be focused on teaching the factual knowledge that an aspirant needs to study for the competitive examinations.</h4>
                </div>
                <div class="mt-4">
                    <div class="address-icon" >
                        <i class="fa fa-circle text-dark"></i>
                    </div>
                    <h4>Attending 2+2 sessions will help an aspirant to learn the factual knowledge that is required to solve prelims questions easily for any competitive examinations.</h4>
                </div>
                <div class="mt-4">
                    <div class="address-icon" >
                        <i class="fa fa-circle text-dark"></i>
                    </div>
                    <h4>It can be an exclusive session on CSAT. The “2+2” CSAT Session will be on teaching the easy techniques that help to solve the questions much faster.</h4>
                </div>
                
                <div class="mt-5">
				<img style="width: 800px; height: 470px; border-radius: 35px; box-shadow: 5px 10px 8px 10px #888888;" src="{{ asset('comimages/head/2+2.PNG')}}">
			</div>
            </div>
                <!-- .row end -->
            </div>
