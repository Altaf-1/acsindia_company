...
<body>
    ...
    <div id="features" class="wrap-bg">
            ...
            <div class="container">
                ...
                <div class="container">
                <div class="row">
                    <h3 class="text-center">Document will be uploaded after discussion in class.</h3>
                    ...
                    <!--            <h4>ENVIRONMENT</h4>-->
                    <!--            <a href="{{asset('https://drive.google.com/file/d/1jHq9cTvXYPIlBM5Rny7q1I5Lkx6OQtLU/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>-->
                    <!--        </div>-->
                    <!--    </div>-->
                        <!-- end single features -->
                    <!--</div>-->
