            ...
            <div class="container">
                <div class="row">
                    <div class="lernen_banner_title">
                        <h1>LITERARY AWARDS OF ASSAM</h1>
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                <span class="first-item">
									<a href="/">Homepage</a></span>
                                <span class="separator">&gt;</span>
                                <span class="last-item">LITERARY AWARDS OF ASSAM</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        <div class="single-features-light text-center">
                            <div>
                                ...
                                <a href="{{asset('https://drive.google.com/file/d/1Nr4Hv5Cx5Rpqvt0ZsMoOSrA70emsrzUR/view?usp=share_link')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                    </div>
