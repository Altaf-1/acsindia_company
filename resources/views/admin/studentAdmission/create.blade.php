            ...
            <div class="row bg-transparent">
                <div class="col-lg-4 p-2">
                    ...
                    <input type="text" class="form-control @error('admission_no') is-invalid @enderror"
                        name="admission_no" placeholder="Admission No" value="{{old('admission_no')}}">
                ...
                <div class="col-lg-4 p-2">
                    ...
                    <input type="text" class="form-control @error('roll_no') is-invalid @enderror" name="roll_no"
                        placeholder="Roll No" value="{{old('roll_no')}}">
                    @error('roll_no')
                    <div class="invalid-feedback mt-2" role="alert">
                        <strong class="alert-danger" class="alert-danger">{{ $message }}</strong>
                    </div>
                ...
                <div class="col-lg-4 p-2">
                    ...
                    <input type="text" class="form-control @error('std_name') is-invalid @enderror" name="std_name"
                        placeholder="Enter Student Name" value="{{old('std_name')}}">
                    @error('std_name')
                    <div class="invalid-feedback mt-2" role="alert">
                        <strong class="alert-danger" class="alert-danger">{{ $message }}</strong>
                    </div>
                ...
                <div class="col-lg-4 p-2">
                    ...
                    <input type="text" class="form-control @error('std_email') is-invalid @enderror" name="std_email"
                        placeholder="Email" value="{{old('std_email')}}">
                    @error('std_email')
                    <div class="invalid-feedback mt-2" role="alert">
                        <strong class="alert-danger" class="alert-danger">{{ $message }}</strong>
                    </div>
                ...
                <div class="col-lg-4 p-2">
                    ...
                    <input type="text" class="form-control @error('std_phone') is-invalid @enderror" name="std_phone"
                        placeholder="Enter Phone Number" value="{{old('std_phone')}}">
                    @error('std_phone')
                    <div class="invalid-feedback mt-2" role="alert">
                        <strong class="alert-danger" class="alert-danger">{{ $message }}</strong>
                    </div>
                ...
                <div class="col-lg-4 p-2">
                    ...
                    <input type="text" class="form-control @error('std_district') is-invalid @enderror"
                        name="std_district" value="{{old('std_district')}}">
                    @error('std_district')
                    <div class="invalid-feedback mt-2" role="alert">
                        <strong class="alert-danger" class="alert-danger">{{ $message }}</strong>
                    </div>
                ...
                <div class="col-lg-4 p-2">
                    ...
                    <select name="std_category" class="form-control">
                        ...
                        <option value="GENERAL" {{ old('std_category') == 'GENERAL' ? 'selected' : '' }}>GENERAL
                        </option>
                        <option value="OBC" {{ old('std_category') == 'OBC' ? 'selected' : '' }}>
                            OBC</option>
                        <option value="SC" {{ old('std_category') == 'SC' ? 'selected' : '' }}>
                            SC</option>
                        <option value="ST" {{ old('std_category') == 'ST' ? 'selected' : '' }}>
                            ST</option>
                        <option value="UR" {{ old('std_category') == 'UR' ? 'selected' : '' }}>
                            UR</option>
                        <option value="OTHERS" {{ old('std_category') == 'OTHERS' ? 'selected' : '' }}>
                            OTHERS</option>
                    </select>
                    @error('std_category')
                    <div class="invalid-feedback mt-2" role="alert">
        ...
        <div class="borderDiv">
            ...
            <div class="row bg-transparent">
                <div class="col-lg-4 p-2">
                    ...
                    <Select name="course" required id="course" class="form-control" onmousedown="this.value='';"
                ...
                <div class="col-lg-4 p-2">
                    ...
                    <input id="discount_amount" onchange="getCourseDiscountAmount()" type="number"
                ...
                <div class="col-lg-4 p-2">
                    ...
                    <input id="refer_discount" type="number" class="form-control
                     @error('refer_discount') is-invalid @enderror" onchange="getCourseDiscountAmount()"
                        name="refer_discount">
                ...
                <div class="col-lg-4 p-2">
                    ...
                    <input type="number" id="course_fee_pay"
                        class="form-control @error('course_fee_pay') is-invalid @enderror" name="course_fee_pay"
                        onchange="getPending(this.value);" required>
                ...
                <div class="col-lg-4 p-2">
                    ...
                    <input id="course_pending" type="number" class="form-control
                     @error('course_pending') is-invalid @enderror" name="course_pending" readonly>
