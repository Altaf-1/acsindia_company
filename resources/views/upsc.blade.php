   ...
   <div id="carouselExampleIndicators" class="carousel slide mt-3 mb-1" data-ride="carousel">
      <div class="carousel-inner">
         <div class="carousel-item active custom-slider">
            <a href="">
            <img class="d-block w-100 h-100" src="{{asset('comimages/2023/head/1.webp')}}" alt="First slide">
            </a>
         </div>
         ...
         <div class="row">
            <div class="col-lg-4 order-last">
               <div class="notice-bord style1">
                  <h4 class="title" style="background-color: #e52e06; font-family: 'Righteous'; !important">Notifications</h4>
                  <ul>
                     <li class="wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                        <div class="date"><span>10</span>JULY</div>
                        <div class="desc"><a href="https://acsindiaias.com/course/ias-booster-course-g">IAS BOOSTER COURSE (K) launched (12 MONTHS).</a></div>
                     </li>
                     <li class="wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                        <div class="date"><span>31</span>JULY</div>
                        <div class="desc"><a href="https://acsindiaias.com/course/ias-booster-course-g">IAS BOOSTER COURSE (L) launched (12 MONTHS).</a></div>
                     </li>
                  ...
                  <div class="sec-title mb-10">
                     <div class="row">
                        <div class="col-lg-6 col-sm-6 col-md-6 text-center justify-content-center">
                           ...
                           <!--   </i>-->
                           <!--</a>-->
                           <a href="https://acsindiaias.com/course" class="shadow_1 d-flex flex-column text-white p-2 rounded-pill mb-2" style="background-color: #134982; font-family: 'Righteous';">Online Courses</a>
                        </div>
                        <div class="col-lg-6 col-sm-6 col-md-6 text-center justify-content-center">
                           <img class="text-danger p-1 mb-4" style="width:110px; boder: 1px solid black; border-radius: 20px;" src="{{asset('comimages/icons/d5.png')}}">
