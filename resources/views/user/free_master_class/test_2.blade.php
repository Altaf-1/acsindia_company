...
<head>
    ...
    <!-- Title -->
    <title>GS TEST - Academy of Civil Services</title>
    <!-- Favicon -->
                    ...
                    <div class="lernen_banner_title">
                        ...
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                ...
                                <span class="last-item">GS TEST</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        <div class="single-features-light text-center">
                            <div>
                                ...
                                <h4>TEST-1</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1no4TfJF9GIBH-rS3WtaPm6g-_DqtDZHu/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        <div class="single-features-light text-center">
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4>TEST-2</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1iSBqPtyUjvZT_Hbf4CHG8dfmgb0j9jq3/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        <div class="single-features-light text-center">
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4>TEST-3</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1OUqgPC8JQMVGLNVj4Iz4SY9M8mjPvWjK/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                    </div>
                </div>
