            ...
            <div class="container">
                <div class="row justify-content-center text-center">
                            ...
                            <div class="card-body " style="text-align: start">
                                ...
                                <br>
                                <strong>Make your payment directly into our bank account. Please upload your receipt in the choose file option. Your order
        ...
        <div class="card container">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link btn active rounded-lg"  id="full-tab" data-toggle="tab" href="#full" role="tab" aria-controls="full" aria-selected="true">Bank Transfer</a>
                </li>
                @endif
                @if($permission)
                <li class="nav-item" role="presentation">
                    <a class="nav-link active rounded-lg"  id="installment-tab" data-toggle="tab" href="#installment" role="tab" aria-controls="installment" aria-selected="false">Installments</a>
                </li>
                @endif
            </ul>
            ...
            <div class="tab-content" id="myTabContent">
                        ...
                        <div class="container">
                            ...
                            <form action="{{route('payment.store')}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        name="payment_type"
                                        class="form-control mr-4" required>
                                        <option
                ...
                <div class="tab-pane fade show active" id="installment" role="tabpanel" aria-labelledby="installment-tab">
                    <div class="card-body">
                        <div class="container">
                            @include('partials.errors')
                            <form action="{{route('payment.installment.store')}}"
                                  method="POST"
                                  enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        class="form-control mr-4" required>
                                        <option
                                            value="Bank Transfer">Installments</option>
                                    </select>
                                </div>
