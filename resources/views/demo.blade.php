		...
		<div id="carouselExampleIndicators">
			<div class="carousel-inner">
			    <div class="carousel-item active custom-slider"  >
				    <a onclick="modal()">
				        <img class="d-block w-100 h-100" src="{{asset('comimages/demo/demo2.png')}}" alt="First slide">
				    </a>
				</div>
			</div>
		</div>
...
<script>
                                                    function modal() {
                                                        Swal.fire({
                                                            html: '<div class="row "> <div class="col-6 p-2 mb-2"><a href="https://acsindiaias.com/upsc_demo">\n' +
                                                                '  <img src="{{asset('comimages/haedi/1.png')}}" width="100%" >\n' +
                                                                ' </a></div>\n' +
                                                                '<div class="col-6 p-2 mb-2"><a href="https://acsindiaias.com/apsc">\n' +
                                                                '  <img src="{{asset('comimages/haedi/2.png')}}" width="100%">\n' +
                                                                '</a></div>\n' ,
                                                            width: 950,
                                                        })
                                                    }
