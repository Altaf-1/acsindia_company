...
@section('content')
    ...
    <table border class="invoice w-75">
        ...
        <tr>
            <td colspan=9"><h5 class="d-flex justify-content-start">{{$student->class}} (Original Amount)</h5></td>
            <td><h5 class="d-flex justify-content-end">{{($student->course_price + $student->discount_amount)}}</h5></td>
        </tr>
        <tr>
            <td colspan="9"><h5 class="header-main d-flex justify-content-end">Discount</h5></td>
            <td><h5 class="d-flex justify-content-end">{{$student->discount_amount}}</h5></td>
        </tr>
        @endif
        @if($student->refer_discount != 0)
        <tr>
            <td colspan="9"><h5 class="header-main d-flex justify-content-end">
                    Refer Code {{$student->refer_code->refer_code}} Discount</h5></td>
            <td><h5 class="d-flex justify-content-end">{{$student->refer_discount}}</h5></td>
        </tr>
        @endif
        <tr>
            <td colspan="2"><h5 class="d-flex justify-content-end">{{$student->class}} (Discount Amount) </h5></td>
            ...
            <td><h5 class="d-flex justify-content-end">{{($student->course_price)}}</h5></td>
        </tr>
        ...
        @foreach($pays as $pay)
           <tr>
                ...
                <td><h5 class="d-flex justify-content-end ">{{\Carbon\Carbon::parse($pay->date)->format('d-M-Y')}}</h5></td>
                <td><h5 class="d-flex justify-content-end ">{{$pay->mode}}</h5></td>
                <td><h5 class="d-flex justify-content-end ">{{number_format((float)(($pay->add_pay/118) * 100), 0, '.', '')}}</h5></td>
                <td><h5 class="d-flex justify-content-end">9%</h5></td>
                <td><h5 class="d-flex justify-content-end">{{number_format((float)((number_format((float)(($pay->add_pay/118) * 100), 0, '.', '')) * (9/100)),0,'.','')}}</h5></td>
                <td><h5 class="d-flex justify-content-end">9%</h5></td>
                <td><h5 class="d-flex justify-content-end">{{number_format((float)((number_format((float)(($pay->add_pay/118) * 100), 0, '.', '')) * (9/100)),0,'.','')}}</h5></td>
                <td><h5 class="d-flex justify-content-end ">{{$pay->add_pay}}</h5></td>
            </tr>
        @endforeach
        <tr>
            ...
            <tr>
            <td colspan="4"><h5 class="header-main m-0">Pending Amount</h5></td>
            <td><h5 class="d-flex justify-content-end">
            ...
            <td><h5 class="d-flex justify-content-end">
                    {{number_format((float)((number_format((float)(($student->course_pending/118) * 100), 0, '.', '')) * (9/100)),0,'.','')}}</h5></td>
            <td><h5 class="d-flex justify-content-end">
                    9%
                </h5></td>
            <td><h5 class="d-flex justify-content-end">{{number_format((float)((number_format((float)(($student->course_pending/118) * 100), 0, '.', '')) * (9/100)),0,'.','')}}</h5></td></h5></td>
            <td><h5 class="d-flex justify-content-end">{{($student->course_pending)}}</h5></td>
        </tr>
        <tr>
            <td colspan="10">
        ...
        <tr>
            ...
            <td colspan="4" ><h5 class="header-main text-left">
