   ...
   <div id="carouselExampleIndicators" class="carousel slide mt-3 mb-1" data-ride="carousel">
      <div class="carousel-inner">
         <div class="carousel-item active custom-slider">
            <a href="">
            <img class="d-block w-100 h-100" src="{{asset('comimages/2023/up1.webp')}}" alt="First slide">
            </a>
         </div>
               ...
               <div class="notice-bord style1">
                  ...
                  <ul>
                     <li class="wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                        <div class="date"><span>17</span>April</div>
                        <div class="desc"><a href="https://acsindiaias.com/course/ias-booster-course-g">IAS BOOSTER COURSE (G) launched (12 MONTHS).</a></div>
                     </li>
                     ...
                     <div class="row">
                        <div class="col-lg-6 col-sm-6 col-md-6 text-center justify-content-center">
                           ...
                           <a href="https://acsindiaias.com/course">
                              <h4 style="background-color: #134982; font-family: 'Righteous';" class="d-flex flex-column btn text-white p-2" >Online Courses</h4>
                              </i>
                           </a>
                        </div>
                        <div class="col-lg-6 col-sm-6 col-md-6 text-center justify-content-center">
