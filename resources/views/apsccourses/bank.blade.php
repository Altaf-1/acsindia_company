    ...
    <div class="card container">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item active" role="presentation">
                <a class="nav-link"  id="installment-tab" data-toggle="tab" href="#installment" role="tab" aria-controls="installment" aria-selected="false">Installments</a>
            </li>
                @endif
        </ul>
        ...
        <div class="card-body">
            <div class="container">
                ...
                <form action="{{route('apsc.bank.payment.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
