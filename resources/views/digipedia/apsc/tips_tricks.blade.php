        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay">
                ...
                <div class="breadcrumbs-text white-color">
                    <h1 class="page-title">TIPS & TRICKS SESSION</h1>
                    <ul>
                        <li>
                            <a class="active" href="index.html">Home</a>
                        </li>
                        <li>TIPS & TRICKS SESSION</li>
                    </ul>
                </div>
            </div>
            <!-- Breadcrumbs End -->
        ...
        <div id="features" class="wrap-bg">
            ...
            <div class="container">
                <div>
                    ...
                    <h4>The second Friday’s class of the second week is called as Tips & Tricks’ Session.</h4>
                </div>
                <div class="mt-4">
                    <div class="address-icon" >
                        <i class="fa fa-circle text-dark"></i>
                    </div>
                    <h4>The objective of the session is to improve the guess work that needs to solve the Prelims questions even without clear knowledge or half knowledge.</h4>
                </div>
                <div class="mt-4">
                    <div class="address-icon" >
                        <i class="fa fa-circle text-dark"></i>
                    </div>
                    <h4>It will be a session on the techniques that can helps to get right answer in the Prelims examination.</h4>
                </div>
                <div class="mt-4">
                    <div class="address-icon" >
                        <i class="fa fa-circle text-dark"></i>
                    </div>
                    <h4>The application of the techniques will be checked in the Live Test programme, where the students can attend the test with the faculty in the same session.</h4>
                </div>
                <div class="mt-5">
				<img style="width: 800px; height: 470px; border-radius: 35px; box-shadow: 5px 10px 8px 10px #888888;" src="{{ asset('comimages/head/tips.PNG')}}">
			</div>
