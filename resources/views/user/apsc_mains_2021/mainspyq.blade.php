            ...
            <div class="container">
                <div class="row">
                    <div class="lernen_banner_title">
                        ...
                        <h4 class="text-white">(UPSC & APSC)</h4>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-6">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h4>UPSC(PYQ)</h4>
                                <a href="/upscmainsdocuments" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-6">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4>APSC(PYQ)</h4>
                                <a href="/apscmainsdocuments" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                </div>
