...
@section('content')
    ...
    <main>
        ...
        <div class="container text-center bg-dark pt-2 pb-2">
            <h4 class="text-white bg-dark">Date: 27th MAY, 2023 (Saturday) | Time: 10.00a.m - 4.00p.m</h4>
            <h4 class="text-white bg-dark">Venue: District Library, Dibrugarh | 9287958409 / 6000903039</h4>
        </div>
                    ...
                    <div class=" container m-auto pt-5">
                        <div class="">
                            <form class="themeioan-form-contact form" method="POST" action="{{ route('seminar.store') }}">
                                ...
                                @endif @csrf
                                <input type="hidden" name="type" value="dibru">
