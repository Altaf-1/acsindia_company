...
@section('content')
    ...
    <div class="container emp-profile mt-3">
        <form action="{{ route('admin.testseriesquestionroll.update', $data->id) }}" method="POST"
            enctype="multipart/form-data">
            @csrf
            @method('patch')
            <input type="hidden" name="test_series_quiz_roll_id" value="{{ $data->test_series_quiz_roll_id }}">
