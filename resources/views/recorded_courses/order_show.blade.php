                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="col-sm-12" style="width:400px;">
                            <img src="{{asset('storage/'.$order->recorded->image)}}" alt="">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-12"><strong>Course Name :</strong> {{$order->recorded->title}}</div>
                        ...
                        @if($order->status == 0)
                            ...
                            <div class="justify-content-start">
                                <a class="btn btn-primary text-white"
                                   href="{{route('user.recorded.pending.payment',$order->id)}}">
                                    Pay Now</a>

                            </div>
                            <div class="justify-content-end">

                                <form action="{{route('recorded.order.delete',$order->id)}}"
                                      method="post">
                                    @csrf
                                    @method('DELETE')
