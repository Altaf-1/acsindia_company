                    ...
                    <div class="row">
                        ...
                        <div class="single-features-light text-center">
                            <div>
                                ...
                                <h4>STUDY PLAN PDF</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1F-GOc7L6Yxegz22qnzhti3zezgif4wtP/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                    </div>
                    </div>
