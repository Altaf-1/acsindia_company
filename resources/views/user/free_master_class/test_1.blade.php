...
<head>
    ...
    <!-- Title -->
    <title>TEST - Academy of Civil Services</title>
    <!-- Favicon -->
                    ...
                    <div class="lernen_banner_title">
                        ...
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                ...
                                <span class="last-item">TEST</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        <div class="single-features-light text-center">
                            <div>
                                ...
                                <h4>ASSAM HISTORY TEST</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1BiS4zzzCZKAhCuDfA9RM0E7K5E-C-9oB/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        <div class="single-features-light text-center">
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4>CSAT TEST</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1gB_BBDIteN20hxOa934gV2MEpaxzvW66/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        <div class="single-features-light text-center">
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4>GS TEST</h4>
                                <a href="{{route('user.free.master.class.test_2')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        <div class="single-features-light text-center">
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4>SPECIFIC QUESTIONS ON ASSAM</h4>
                                <a href="{{asset('https://drive.google.com/file/d/11B7Vwjlaco9vaLKHKO69mpKoQoV2e2Hj/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                    </div>
                </div>
