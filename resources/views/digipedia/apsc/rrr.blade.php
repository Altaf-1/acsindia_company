        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay">
                ...
                <div class="breadcrumbs-text white-color">
                    <h1 class="page-title">RRR SESSION</h1>
                    <ul>
                        <li>
        ...
        <div id="features" class="wrap-bg">
            ...
            <div class="container">
                <div>
                    ...
                    <h4>The third day of the third week class is called as RRR Session.</h4>
                </div>
                <div class="mt-4">
                    <div class="address-icon" >
                        <i class="fa fa-circle text-dark"></i>
                    </div>
                    <h4>Revision is the key to success. It acts as a vaccine for enhancing preparation strategies and knowledge.</h4>
                </div>
                <div class="mt-4">
                    <div class="address-icon" >
                        <i class="fa fa-circle text-dark"></i>
                    </div>
                    <h4>The word “RRR” stands for “Read, Revise & Repeat”.</h4>
                </div>
                <div class="mt-4">
                    <div class="address-icon" >
                        <i class="fa fa-circle text-dark"></i>
                    </div>
                    <h4>The session mainly focuses on revising the content which is taught in the previous week or previous month from the particular subject.</h4>
                </div>
                <div class="mt-4">
                    <div class="address-icon" >
                        <i class="fa fa-circle text-dark"></i>
                    </div>
                    <h4>It can be a revision of the current affairs topics.</h4>
                </div>
                <div class="mt-5">
				<img style="width: 800px; height: 470px; border-radius: 35px; box-shadow: 5px 10px 8px 10px #888888;" src="{{ asset('comimages/head/RRR.PNG')}}">
			</div>
            </div>
                <!-- .row end -->
            </div>
