...
<main>
    ...
    <div class="container text-center bg-dark pt-2 pb-2">
        <h4 class="text-white bg-dark">Date: 14 MAY, 2023 (Sunday) | Time: 10.00a.m - 4.00p.m</h4>
        <h4 class="text-white bg-dark">Venue: Ranghar Auditorium Dibrugarh University | 9287958409 / 6000903039</h4>
    </div>
    ...
    <section id="regis">
        <div id="contact" class="wrap-bg pt-0" style="background-image: url({{asset('comimages/help.webp')}});">
            <div class="container-fluid">
                <div style="background-color:#d1620d;" class="row justify-content-center text-center text-white">
                    <div class="col-lg-8">
...
@endif
 @csrf
                            ...
                            <div>
                                <input value="{{old('name')}}" required class="input-text required-field" type="text" name="name" id="contactName" placeholder="Name" title="Your Full Name" />
                            </div>
                            <div>
                                <input value="{{old('email')}}" required class="input-text required-field email-field" type="email" name="email" id="contactEmail" placeholder="Email" title="Your Email" />
                            </div>
                            <div>
                                <input value="{{old('phone')}}" required class="input-text required-field" type="text" name="phone" id="contactSubject" placeholder="Phone number" />
                            </div>
                            <div>
                            ...
                            <div>
                                <input value="{{old('city')}}" required class="input-text required-field" type="text" name="city" id="city" placeholder="City" title="Your City" />
                            </div>
                            <div>
                                <input value="{{old('qualification')}}" required class="input-text required-field" type="text" name="qualification" id="qualification" placeholder="Present Qualification" title="Your Qualification" />
                            </div>
                                ...
                                <div>
                                    ...
                                    <label class="input-text text-white" for="quiz"><h3 class="text-white pt-3">Solo Quiz</h3></label>
                                </div>
...
<script>
    ...
    var countDownDate = new Date("September 11, 2022 15:37:25").getTime();
