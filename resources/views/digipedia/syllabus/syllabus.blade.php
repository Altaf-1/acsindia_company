...
<head>
    ...
    <!-- Title -->
    <title>IAS SYLLABUS - Academy of Civil Services</title>
    <!-- Favicon -->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse " id="navbarCollapse">
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <li class="subnav">
                            <a href="#features">Ias Syllabus</a>
                        </li>
                    </ul>
                </div>
                <!-- Menu Toogle end -->
                    ...
                    <div class="lernen_banner_title">
                        ...
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                ...
                                <span class="last-item">Ias Syllabus</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>MAINS</h4>
                                <a href="/mains" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
