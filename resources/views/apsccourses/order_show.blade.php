                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="col-sm-12" style="width:400px;">
                            <img src="{{asset('storage/'.$order->apsc_course->image)}}" alt="">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-12"><strong>Course Name :</strong> {{$order->apsc_course->title}}</div>
                            ...
                            <div class="d-flex">
                                <div class="justify-content-start">
                                    <a class="btn btn-primary text-white"
                                       href="{{route('apsc.order.pending.payment',$order->id)}}">
                                        Pay Now
                                    </a>
                                ...
                                <div class="justify-content-end">
                                    ...
                                    <form action="{{route('apsc.order.delete',$order->id)}}"
                                          method="post">
                                        @csrf
                                        @method('DELETE')
