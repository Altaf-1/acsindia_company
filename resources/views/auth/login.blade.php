            ...
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    <div class="row mb-4 px-3">
                        <h3 class="mb-0 mr-4 mt-2 font-weight-bold">Login</h3>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row px-3">
                            ...
                            </label> <input class="mb-4 form-control @error('email') is-invalid @enderror" id="email"
                                            type="email"
                                            name="email"
                        ...
                        <div class="row px-3">
                            <label class="mb-1">
                                <h6 class="mb-0 front-weight-bold">Password</h6>
                            </label>
                        ...
                        <div class="row px-3 mb-4">
                            <div class="custom-control custom-checkbox custom-control-inline">
                                ...
                                <label for="remember" class="custom-control-label text-sm">Remember me</label></div>
                          <a href="{{ route('password.request') }}" class="ml-auto mb-0 text-sm">Forgot Password?</a>
                        </div>
                        <div class="row mb-3 px-3">
                            <button type="submit" class="btn btn-blue text-center">Login</button>
                        </div>
                        <div class="row mb-4 px-3"><h5 class="font-weight-bold">Don't have an account? <a
                                    class="text-white btn btn-danger" href="{{ route('register') }}">Register Your Account</a></h5></div>
                    </form>
                </div>
            </div>
        </div>
