...
@section('content')
    ...
    <section class="container emp-profile rounded border w-50" style="margin-top: 150px; margin-bottom: 50px">
        ...
        @foreach($students as $student)
            <a href="{{route('user.chat.chatPanel', $student->student_id)}}" class="tag">
                <section  class="container emp-profile rounded shadow-lg p-3 border chatList d-flex justify-content-around" style="margin-top: 20px; cursor: pointer">
