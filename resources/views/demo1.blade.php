                ...
                <div class="row">
                    <div class="col-lg-12 p-2">
                        <div class="shadow-lg bg-body rounded">
                            <a href="https://acsindiaias.com/upsc_demo"><img src="{{asset('comimages/haedi/1.png')}}"
                                    class="card-img1" alt="..."></a>
                        </div>
                    </div>
                    <div class="col-lg-12 p-2">
                    ...
                    <div class="col-lg-5 lg-pr-0 md-mb-50">
                        <div class="choose-us-part">
                            <div class="sec-title wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                                ...
                                <h3 class="mt-4 text-white">Aspirations of Academy of Civil Services move hand in hand
                                    with the Indian Civil Services Aspirants. Success of each aspirant is our priority.
                                    We believe in pure ethical form of service, with zero tolerance in quality learning
                                    at an affordable price for each fellow Indian.</h3>
                            ...
                            <div class="facilities-part mt-5">
                                ...
                                <div class="single-facility wow fadeInUp" data-wow-delay="300ms"
                                    ...
                                    <div class="icon-part one mt-5">
                                        ...
                                        <spam class="display-6 ml-4 text-white">Online & Offline Classes</spam>
                                    </div>
                                </div>
                                <div class="single-facility wow fadeInUp" data-wow-delay="300ms"
                                    data-wow-duration="2000ms">
                                    <div class="icon-part one mt-5 mb-5">
                                        ...
                                        <spam class="display-6 ml-4 text-white">High Quality Materials</spam>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 offset-lg-1 lg-pl-0">
                        <div class="free-course-contact">
                            <div id="form-messages">
                                <h4 class="text-white text-center">Book Your Free Class</h4>
                            </div>
                            <form class="themeioan-form-contact form" method="get" action="{{route('query')}}">
                                ...
                                <div class="form-btn submit-btn mt-30">
                                    <button type="submit" class="btn text-white display-6 p-4"
                                        style="background-color: #F68C1F">Register</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-12">
                            <div class="d-flex flex-row">
                                ...
                                <h4 style="padding-top: 25px; padding-left: 40px; color: #fff;">acsindia.ias@gmail.com
                                </h4>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-12">
                            <div class="d-flex flex-row">
                                <div class="d-flex flex-column">
                                    <h4 class="text-center underline"
                                        style="padding-top: 15px; padding-left: 40px; color: #fff;"><u>DIBRUGARH
                                            CENTER</u></h4>
                                    <h4 style="padding-top: 15px; padding-left: 40px; color: #fff;">NALIAPOOL,DIBRUGARH
                                    </h4>
                                    <h4 style="padding-top: 15px; padding-left: 40px; color: #fff;">Near Ganesh Mandir
                                    </h4>
                        ...
                        <div class="col-lg-3 col-sm-12">
                            <div class="d-flex flex-row">
                                <div class="d-flex flex-column">
                                    <h4 class="text-center underline"
                                        style="padding-top: 15px; padding-left: 40px; color: #fff;"><u>GUWAHATI
                                            CENTER</u></h4>
