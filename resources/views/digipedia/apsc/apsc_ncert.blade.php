        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay">
                ...
                <div class="breadcrumbs-text white-color">
                    <h1 class="page-title">APSC PRELIMS PYQ</h1>
                    <ul>
                        <li>
                            <a class="active" href="index.html">Home</a>
                        </li>
                        <li>APSC PRELIMS PYQ</li>
                    </ul>
                </div>
            </div>
            <!-- Breadcrumbs End -->
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h4>INDIAN POLITY</h4>
                                <a href="/indian_polity" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <a href="/geography" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 ">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>INDIAN HISTORY</h4>
                                <a href="/indian_history" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 ">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <a href="/indian_economy" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 ">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>SCIENCE</h4>
                                <a href="/science-topic" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
