                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h4>GS-1</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1G5Bvk6sUMed-enefI_k4Lkyv_qB0zXve/view?usp=sharing')}}" class=" btn color-two button text-white" target="_blank">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
