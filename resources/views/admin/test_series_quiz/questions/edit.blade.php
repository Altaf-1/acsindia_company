...
@section('content')
    ...
    <div class="container emp-profile mt-3">
        <form action="{{ route('admin.testseriesquestion.update', $data->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <input type="hidden" name="test_series_quiz_id" value="{{ $data->test_series_quiz_id }}">
            ...
            <div class="form-group font-weight-bold">
                ...
                <Select name="correct_option" class="form-control col-2">
                    <option 
                    @if($data->correct_option === $data->option1)
                        value="option1" 
