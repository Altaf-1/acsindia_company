                                ...
                                <article>
                                    ...
                                    <div class="blog-photo ">
                                        <img class="img-fluid course-img"
                                             src="{{asset('cor/1.png')}}" alt="">
                                    </div>
                                    <div class="blog-content">
                                        <h5 class="title text-center">---- SELECT DATE ----</h5>
                                        <ul class="themeioan_ul_icon justify-content-center text-center">
                                            <li><a href="https://acsindiaias.com/course/ias-booster-course-n" class=" btn color-two button text-white mb-3">25 SEP</a></li>
                                        </ul>
                                    </div>
                                </article>
                                <!-- end single course -->
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 p-0 course-animation mb20">
                            ...
                            <div class="themeioan_course">
                                <article>
                                    ...
                                    <div class="blog-photo ">
                                        <img class="img-fluid course-img"
                                             src="{{asset('cor/main/3.png')}}" alt="">
                                    </div>
                                    <div class="blog-content">
                                        <h5 class="title text-center">---- SELECT DATE ----</h5>
                                        <ul class="themeioan_ul_icon justify-content-center text-center">
                                            <li><a href="https://acsindiaias.com/course/ias-booster-course-p" class=" btn color-two button text-white mb-3">25 SEP</a></li>
                                        </ul>
                                    </div>
                                </article>
                                <!-- end single course -->
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 p-0 course-animation mb20">
                            <div class="themeioan_course">
                                <article>
                                    <div class="blog-photo ">
                                        <img class="img-fluid course-img"
                                             src="{{asset('cor/main/5.png')}}" alt="">
                                    </div>
                                    <div class="blog-content">
                                        <h5 class="title text-center">---- SELECT DATE ----</h5>
                                        <ul class="themeioan_ul_icon justify-content-center text-center">
                                            <li><a href="https://acsindiaias.com/course/ias-booster-course-0" class=" btn color-two button text-white mb-3">4 SEP</a></li>
                                            <li><a href="https://acsindiaias.com/course/ias-booster-course-q" class=" btn color-two button text-white mb-3">9 Oct</a></li>
                                        </ul>
                                    </div>
                                </article>
                            </div>
                            ...
                            <div class="themeioan_course">
                                <article>
                                    ...
                                    <div class="blog-content">
                                        ...
                                        <ul class="themeioan_ul_icon justify-content-center text-center">
                                            <li><a href="https://acsindiaias.com/user/study/show/33" class=" btn color-two button text-white mb-3">Enroll Now</a></li>
                                        </ul>
                                    </div>
                                </article>
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 p-0 course-animation course-single mb20">
                            ...
                            <div class="themeioan_course">
                                <article>
                                    ...
                                    <div class="blog-photo ">
                                        <img class="img-fluid course-img"
                                             src="{{asset('storage/'.$rcourse->image)}}" alt="">
                                    </div>
                                    <div class="blog-content">
                                        <h5 class="title">{{$rcourse->title}}</h5>
                                        <ul class="themeioan_ul_icon">
                                            {!! $rcourse->front_options !!}
                                        </ul>
                                        <ul class="course-bottom-list justify-content-end">
                                            <li>
                                                <div class="course-duration">
                                                    <span class="fa fa-clock-o"></span>
                                                    <a href="{{route('recorded.show', $rcourse->slug)}}"
                                                       class=" btn color-two button text-white">KNOW
                                                        MORE</a>
                                                </div>
                                            </li>
