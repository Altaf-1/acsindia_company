...
<head>
    ...
    <!-- Title -->
    <title>APSC MAINS TEST SERIES - Academy of Civil Services</title>
    <!-- Favicon -->
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pb-3">
                        ...
                        <div class="single-features-light text-center">
                            <!-- single features -->
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x mb-3"></i>
                                <h3>ESSAY</h3>
                                <h4>28th Nov 2021</h4>
                                <a href="{{asset('https://forms.gle/SD4b9EtsngLAgTGcA')}}" class="btn color-two button text-white" target="_blank" >SUBMIT YOUR ANSWER</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pb-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x mb-3"></i>
                                <h3>GENERAL STUDIES-I</h3>
                                <h4>2nd Dec 2021</h4>
                                <a href="{{asset('https://forms.gle/5AuzUBNZRyFrJq4aA')}}" class="btn color-two button text-white" >SUBMIT YOUR ANSWER</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pb-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x mb-3"></i>
                                <h3>GENERAL STUDIES-II</h3>
                                <h4>5th Dec 2021</h4>
                                <a href="{{asset('https://forms.gle/KtpwwkcDp8eJd5JV6')}}" class="btn color-two button text-white" >SUBMIT YOUR ANSWER</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pb-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x mb-3"></i>
                                <h3>GENERAL STUDIES-III</h3>
                                <h4>8th Dec 2021</h4>
                                <a href="{{asset('https://forms.gle/TBgmmz4meuub3vbq7')}}" class="btn color-two button text-white" >SUBMIT YOUR ANSWER</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pb-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x mb-3"></i>
                                <h3>GENERAL STUDIES-IV</h3>
                                <h4>11th Dec 2021</h4>
                                <a href="{{asset('https://forms.gle/1BYBcZz3nehYPdLV7')}}" class="btn color-two button text-white" >SUBMIT YOUR ANSWER</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pb-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h3>ESSAY</h3>
                                <h4>22nd Dec 2021</h4>
                                <a href="{{asset('https://forms.gle/CPoWLibFXbpVL2iU9')}}" class="btn color-two button text-white" target"_blank" >SUBMIT YOUR ANSWER</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pb-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h3>GENERAL STUDIES-I</h3>
                                <h4>26th Dec 2021</h4>
                                <a href="{{asset('https://forms.gle/M2TbXNHWSATEA7qY9')}}" class="btn color-two button text-white" >SUBMIT YOUR ANSWER</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pb-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h3>GENERAL STUDIES-II</h3>
                                <h4>8th Jan 2022</h4>
                                <a href="{{asset('https://forms.gle/Sh7a2T4ca7toFFGc8')}}" class="btn color-two button text-white" >SUBMIT YOUR ANSWER</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pb-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h3>GENERAL STUDIES-III</h3>
                                <h4>15 Jan 2022</h4>
                                <a href="{{asset('')}}" class="btn color-two button text-white disabled" >SUBMIT YOUR ANSWER</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pb-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h3>GENERAL STUDIES-IV</h3>
                                <h4>22 Jan 2022</h4>
                                <a href="{{asset('https://forms.gle/CjD7obbJcQFiNG9QA')}}" class="btn color-two button text-white" >SUBMIT YOUR ANSWER</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
