...
@section('content')
    ...
    <div class="py-3">
        <h6 class="m-0 font-weight-bold text-primary">Create Daily News Analyse</h6>
    </div>
    <hr>
    <div class="container emp-profile mt-3">
        <form action="{{ route('admin.dailynewsanalyse.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
