                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                ...
                                <h4 class="text-uppercase">January</h4>
                                <a href="https://drive.google.com/file/d/1QOjCkEY3l7IbmNgPClu9GthEC-C_IXE7/view?usp=sharing" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <!-- uses solid style -->
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4 class="text-uppercase">June</h4>
                                <a href="https://drive.google.com/file/d/1r2YteXc6JC8gEymFN_EjPR6NR-CciqIj/view?usp=sharing" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
