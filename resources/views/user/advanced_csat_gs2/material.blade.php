                ...
                <div class="row">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <form action="{{route('user.pdf-view.index')}}" method="post">
                                        ...
                                        <input type="hidden"
                                               name="drive_link"
                                               value="https://drive.google.com/file/d/14_BVrvol6GeD78BXNWVgQwjk1Ggv7AB9/">
                                        <button type="submit" class="btn color-two button text-white">Open</button>
                                    </form>
                            </div>
                        </div>
                        <!-- end single features -->
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <form action="{{route('user.pdf-view.index')}}" method="post">
                                        ...
                                        <input type="hidden"
                                               name="drive_link"
                                               value="https://drive.google.com/file/d/19EMrLygSnh-rAjTVjd5z14cz058pK8P2/">
                                        <button type="submit" class="btn color-two button text-white">Open</button>
                                    </form>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4>CSAT Number Series to Speed </h4>
                                <form action="{{route('user.pdf-view.index')}}" method="post">
                                        @csrf
                                        <input type="hidden"
                                               name="drive_link"
                                               value="https://drive.google.com/file/d/1jLsUMatJMxztR4iX9zLSOkijsCY5Kw7y/">
                                        <button type="submit" class="btn color-two button text-white">Open</button>
                                    </form>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4>CSAT- Blood Relationship </h4>
                                <form action="{{route('user.pdf-view.index')}}" method="post">
                                        @csrf
                                        <input type="hidden"
                                               name="drive_link"
                                               value="https://drive.google.com/file/d/1EAJtn2XFWDuRBPRr_3bQ_X95H9hNf9w4/">
                                        <button type="submit" class="btn color-two button text-white">Open</button>
                                    </form>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4>Number Series to Number System </h4>
                                <form action="{{route('user.pdf-view.index')}}" method="post">
                                        @csrf
                                        <input type="hidden"
                                               name="drive_link"
                                               value="https://drive.google.com/file/d/1uCippD75KX0xIS2ZqGsGxOxUtc_Shym2/">
                                        <button type="submit" class="btn color-two button text-white">Open</button>
                                    </form>
                            </div>
                        </div>
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <form action="{{route('user.pdf-view.index')}}" method="post">
                                        ...
                                        <input type="hidden"
                                               name="drive_link"
                                               value="https://drive.google.com/file/d/19qgRxGuII-r1L7VuIymQSpkThIvJc3Ow/">
                                        <button type="submit" class="btn color-two button text-white">Open</button>
                                    </form>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4>Ranking to Triangle </h4>
                                <form action="{{route('user.pdf-view.index')}}" method="post">
                                        @csrf
                                        <input type="hidden"
                                               name="drive_link"
                                               value="https://drive.google.com/file/d/1hoGD32D-116QUpD7AzMhCw4GU77BqQ9E/">
                                        <button type="submit" class="btn color-two button text-white">Open</button>
                                    </form>
                            </div>
                        </div>
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <form action="{{route('user.pdf-view.index')}}" method="post">
                                        ...
                                        <input type="hidden"
                                               name="drive_link"
                                               value="https://drive.google.com/file/d/1nIQryS8gRGS5sUdtol4lVORA8xWpGPij/">
                                        <button type="submit" class="btn color-two button text-white">Open</button>
                                    </form>
                            </div>
                        </div>
