                    ...
                    <div class="container">
                        ...
                        <div class="header-nav-inner">
                            <div data-items="8"
                                ...
                                <div>
                                    <span><a href="https://acsindiaias.com/"><img src="{{asset('img/log1.jpg')}}" alt="logo" width="190"></a></span>
                                </div>
                            </div><!-- block category -->
                            <div class="box-header-nav menu-nocenter">
                                <ul id="menu-primary-menu"
                                    ...
                                    <li id="menu-item-229"
                                        ...
                                        <div class="dropdown">
                        <a href="https://acsindiaias.com/upsc" class="btn dropbtn" style="font-family: 'Righteous';">HOME <spam><i class="fa fa-caret-down" aria-hidden="true"></i></spam></a>
                        <div class="dropdown-content">
                            <a href="https://acsindiaias.com/aboutus">About Us</a>
                            <a href="https://acsindiaias.com/contact">Contact Us</a>
                            <a href="https://acsindiaias.com/apply-job">Apply Job</a>
                          </div>
                        </div>
                                    </li>
                                    <li id="menu-item-230"
                                        ...
                                        <div class="dropdown">
                        <a href="https://acsindiaias.com/upsc" class="btn dropbtn" style="font-family: 'Righteous';">UPSC <spam><i class="fa fa-caret-down" aria-hidden="true"></i></spam></a>
                        <div class="dropdown-content">
                            <a href="https://acsindiaias.com/course">Online Courses</a>
                            <a href="https://acsindiaias.com/current_affairs_2023">Current Affairs</a>
                            ...
                            <a href="https://acsindiaias.com/digipedia">NCERT Books</a>
                                    ...
                                    <li id="menu-item-228"
                                        ...
                                        <div class="dropdown">
                        <a href="https://acsindiaias.com/apsc" class="btn dropbtn" style="font-family: 'Righteous';">APSC <spam><i class="fa fa-caret-down" aria-hidden="true"></i></spam></a>
                        <div class="dropdown-content">
                            ...
                            <a href="https://acsindiaias.com/digipedia">NCERT Books</a>
                                    ...
                                    <li id="menu-item-238"
                                        ...
                                        @auth
                                        <div class="dropdown">
                        <a class="btn dropbtn text-white" style="background-color: #e52e06; font-family: 'Righteous';">{{ Auth::user()->name }}<spam><i class="fa fa-caret-down" aria-hidden="true"></i></spam></a>
                        <div class="dropdown-content">
                        ...
                        @if(Auth::user()->role == 'admin')
                            <a href="{{ route('admin.index') }}" >Admin Panel</a>
                            @endif
                            <a href="https://acsindiaias.com/current-affair/current_affair" href="{{ route('logout') }}" onclick="event.preventDefault();
