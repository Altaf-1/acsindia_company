...
@section('title')
    TEST CENTER - Academy of Civil Services
@endsection
@section('links')
    <!-- Favicon -->
                    ...
                    <div class="lernen_banner_title">
                        ...
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                ...
                                <span class="last-item">Test Center</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            ...
                            <div class="single-features-light text-center bg-light">
                                ...
                                <div>
                                    ...
                                    <a href="{{route('user.new.test.main.topic',$course)}}" class=" btn color-two button text-white">Main</a><br>
                                </div>
                            </div>
                            <!-- end single features -->
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            ...
                            <div class="single-features-light text-center bg-light">
                                ...
                                <div>
                                    ...
                                    <a href="{{route('user.new.test.prelims.topic',$course)}}" class=" btn color-two button text-white">Prelims</a><br>
                                </div>
                            </div>
                            <!-- end single features -->
                        </div>
