            ...
            <div class="container">
                <div class="row">
                    <div class="lernen_banner_title">
                        <h1 class="text-uppercase">{{$sub_topic}}</h1>
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                <span class="first-item">
									<a href="/">Homepage</a></span>
                                <span class="separator">&gt;</span>
                                <span class="last-item text-capitalize">{{$sub_topic}}</span>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 mt-4">
                                ...
                                <div class="single-features-light text-center bg-light">
                                    ...
                                    <div>
                                        ...
                                        <h4>{{$video->title}}</h4>
                                        <h4>{{$video->date}}</h4>
                                        <a href="{{route('user.new.video.play', $video->id)}}" class=" btn color-two button text-white">PLAY</a><br>
                                        @if($video->knowledge)
