                     ...
                     <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 mt-3">
                            <div class="single-features-light text-center">
                                <div>
                                    <i class="base-color fas fa-book fa-3x"></i>
                                    <h4>MY STUDY ROOM</h4>
                                    <a href="{{ route('digipedia.self.index') }}"
                                        class=" btn color-two button text-white">View</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                @if ($course->title == 'OFFLINE BATCH (G-2023) BATCH-2')
                                    <a href="{{ route('user.recorded.offline.batch.g.2023.batch-2.plan') }}"
                                        target="_blank" class=" btn color-two button text-white">View</a>
                                @endif
                                @if ($course->title == 'OFFLINE BATCH (D-2023) BATCH-2')
                                    <a href="{{ route('user.recorded.offline.batch.d.2023.batch-2.plan') }}"
                                        target="_blank" class=" btn color-two button text-white">View</a>
                                @endif
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 mt-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                @endif
                                @if ($course->title == 'OFFLINE BATCH (G-2023) BATCH-2')
                                    <a href="{{ route('user.recorded.offline.batch.g.2023.batch-2.material') }}"
                                        target="_blank" class=" btn color-two button text-white">View</a>
                                @endif
                                @if ($course->title == 'OFFLINE BATCH (D-2023) BATCH-2')
                                    <a href="{{ route('user.recorded.offline.batch.d.2023.batch-2.material') }}"
                                        target="_blank" class=" btn color-two button text-white">View</a>
                                @endif
                                @if ($course->title == 'IAS WORKSHOP')
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 mt-3">
                            ...
                            <div class="single-features-light text-center">
                                ...
                                <div>
                                    ...
                                    @endif
                                    @if ($course->title == 'IAS OFFLINE BATCH 2022')
                                        <a href="{{ route('user.regular.paper') }}"
                                            class=" btn color-two button text-white">VIEW</a>
                                    @endif
                                    @if ($course->title == 'OFFLINE BATCH (G-2023)')
                                    ...
                                    @endif
                                    @if ($course->title == 'OFFLINE BATCH (G-2023) BATCH-2')
                                        <a href="{{ route('user.recorded.offline.batch.g.2023.batch-2.paper') }}"
                                            target="_blank" class=" btn color-two button text-white">View</a>
                                    @endif
                                    @if ($course->title == 'OFFLINE BATCH (D-2023) BATCH-2')
                                        <a href="{{ route('user.recorded.offline.batch.d.2023.batch-2.paper') }}"
                                            target="_blank" class=" btn color-two button text-white">View</a>
                                    @endif
                                </div>
                            </div>
