...
@section('content')
    ...
    <div class="py-3">
        <h6 class="m-0 font-weight-bold text-primary">Updating RECORDED Course {{$course->title}}</h6>
    </div>
    <hr>
    <div class="container emp-profile mt-3">
        <form action="{{ route('admin.recorded.update', $course->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            ...
            <div class="form-group font-weight-bold">
                ...
                <input type="text" value="{{$course->days}}" style="border-radius: 20px;" class="form-control" name="days" placeholder="eg: 10 months, 1 year">
            </div>

            <div class="form-group font-weight-bold">
                <label for="timing">Total Hours:</label>
                <input type="text" value="{{$course->timing}}" style="border-radius: 20px;" class="form-control" name="timing" placeholder="eg: 10 hours, 2 hours">
            </div>
            ...
            <div class="form-group font-weight-bold">
                ...
                <input type="number" value="{{$course->sale}}" style="border-radius: 20px;" class="form-control" name="sale" placeholder="Sale Price">
            </div>

            <div class="form-group font-weight-bold">
                <label for="discount">Discount:</label>
                <input type="number" value="{{$course->discount}}" style="border-radius: 20px;" class="form-control" name="discount" placeholder="percentenge value eg: 20, 30">
            </div>
