...
@section('content')
    ...
    <div class="container emp-profile mt-3">
        <form action="{{ route('admin.faculty_poll_question.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="faculty_poll_id" value="{{ $id }}">
            ...
            <div class="form-group font-weight-bold">
                ...
                <input type="text" style="border-radius: 20px;" class="form-control" name="option_1"
                    placeholder="Enter option_1">
            </div>

            <div class="form-group font-weight-bold">
                <label for="option_2">Option 2:</label>
                <input type="text" style="border-radius: 20px;" class="form-control" name="option_2"
                    placeholder="Enter option_2">
            </div>

            <div class="form-group font-weight-bold">
                <label for="option_3">Option 3:</label>
                <input type="text" style="border-radius: 20px;" class="form-control" name="option_3"
                    placeholder="Enter option_3">
            </div>

            <div class="form-group font-weight-bold">
                <label for="option_4">Option 4:</label>
                <input type="text" style="border-radius: 20px;" class="form-control" name="option_4"
