            ...
            <div class="col-sm-6">
                ...
                <div class="form-group font-weight-bold">
                    ...
                    <textarea class="form-control" name="front_options"
                              PLACEHOLDER="<li><i class='fas fa-check-circle'></i> Daily Q&A session.</li>">{!! $course->front_options !!}</textarea>
                </div>

                <div class="form-group font-weight-bold">
                    <label for="options">Options: </label>
                    <textarea class="form-control" name="options"
                              PLACEHOLDER="<li><i class='fas fa-check-circle'></i> Daily Q&A session.</li>">{!! $course->options !!}</textarea>
                </div>
            </div>
