            ...
            <div class="container">
                <div class="row">
                    <div class="lernen_banner_title">
                        <h1>Ultimate Package For Aspirants</h1>
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                <span class="first-item">
									<a href="/">Homepage</a></span>
                                <span class="separator">&gt;</span>
                                <span class="last-item">Self Study</span>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <article>
                                    ...
                                    <div class="blog-photo ">
                                        <img class="img-fluid course-img"
                                             src="{{asset('comimages/self/11.png')}}" alt="">
                                    </div>
                                    <div class="blog-content">
                                        <h5 class="title">SELF STUDY COURSE (UPSC)</h5>
                                        <ul class="course-bottom-list justify-content-end">
                                            <li>
                                                <div class="course-duration">
                                                    <span class="fa fa-clock-o"></span>
                                                    <a href="https://acsindiaias.com/recorded/course/self-study-course-upsc"
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 p-0 course-animation mb20">
                            ...
                            <div class="themeioan_course">
                                <article>
                                    ...
                                    <div class="blog-photo ">
                                        <img class="img-fluid course-img"
                                             src="{{asset('comimages/self/22.png')}}" alt="">
                                    </div>
                                    <div class="blog-content">
                                        <h5 class="title">SELF STUDY COURSE (UPSC + APSC)</h5>
                                        <ul class="course-bottom-list justify-content-end">
                                            <li>
                                                <div class="course-duration">
                                                    <span class="fa fa-clock-o"></span>
                                                    <a href="https://acsindiaias.com/recorded/course/self-study-course-upsc-apsc"
                                                       class=" btn color-two button text-white">KNOW
                                                        MORE</a>
                                                </div>
                                            </li>
