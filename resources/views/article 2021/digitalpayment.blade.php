...
<body>
    ...
    <main>
            ...
            <div class="container">
                <div class="row">
                    <div class="lernen_banner_title">
                        <h1 class="text-uppercase">DIGITAL PAYMENT INDEX</h1>
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                <span class="first-item">
									<a href="/">Homepage</a></span>
                                <span class="separator">&gt;</span>
                                <span class="last-item">DIGITAL PAYMENT INDEX</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="sigle-address ml-5 pt-2" aria-hidden="true">
            ...
            <h4 class="text-dark">It is launched by Reserve Bank of India.</h4>
        </div>
        </div>
        <div class="sigle-address ml-3 pt-2" aria-hidden="true">
            ...
            <h4 class="text-dark">The index was set as 100 in March 2018 (the base period) and it stood at 153.47 in March 2019.  While in September 2020, the index stood at 217.74.</h4>
        </div>
        <div class="sigle-address ml-4" aria-hidden="true">
            <div class="address-icon ml-3" >
                <i class="fa fa-circle text-dark"></i>
            </div>
            <h4 class="text-dark">It rose to 270.59 in March 2021.</h4>
        </div>
        <div class="sigle-address ml-3" aria-hidden="true">
            <div class="address-icon ml-4" >
                <i class="fa fa-circle text-dark"></i>
            </div>
            <h4 class="text-dark">The index aims to assess the extent of digitization of payments in the country.</h4>
        </div>
        </div>
