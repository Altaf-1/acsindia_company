...
<head>
    ...
    <!-- Title -->
    <title>ASSAM HISTORY IN 7 PAGE- Academy of Civil Services</title>
    <!-- Favicon -->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse " id="navbarCollapse">
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <li class="subnav">
                            <a href="#features">ASSAM HISTORY</a>
                        </li>
                    </ul>
                </div>
                <!-- Menu Toogle end -->
            ...
            <div class="container">
                <div class="row">
                    <div class="lernen_banner_title">
                        <h1>ASSAM HISTORY IN 7 PAGE</h1>
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                <span class="first-item">
									<a href="/">Homepage</a></span>
                                <span class="separator">&gt;</span>
                                <span class="last-item">ASSAM HISTORY IN 7 PAGE</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        <div class="single-features-light text-center">
                            <div>
                                ...
                                <h4>ASSAM HISTORY IN 7 PAGE</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1pha59xTencanHdsz2Kc58kQQ1SPD1iAU/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                    </div>
