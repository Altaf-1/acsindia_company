    ...
    <div class="container p-2">
        ...
        <div class="row ">
            ...
            <div class="col-12 d-flex p-5 justify-content-center">
                @if(\App\VideoRatingNew::where('user_id', \Illuminate\Support\Facades\Auth::user()->id)->where('video_id', $video->id)->get()->first() !== null)
                    <div class="feedback">
                        <h4>Thank you for your Valuable Rating of
                            <strong>{{\App\VideoRatingNew::where('user_id', \Illuminate\Support\Facades\Auth::user()->id)->where('video_id', $video->id)->get()->first()->rating}}</strong> Star </h4>
                    </div>
                @else
                    <form action="{{route('video.rating-new.store')}}" method="post">
                        @csrf
                        <div class="feedback">
