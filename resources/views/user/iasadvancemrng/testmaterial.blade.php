...
<head>
    ...
    <!-- Title -->
    <title>TEST SERIES - Academy of Civil Services</title>
    <!-- Favicon -->
            ...
            <div class="container">
                <div class="row">
                    <div class="lernen_banner_title">
                        <h2 class="text-white">TEST SERIES</h2>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h4>TEST CENTER</h4>
                                <a href="{{route('user.tests.index',$course)}}" class="btn color-two button text-white">ENTER</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4>RESULTS</h4>
                                <a href="{{route('user.result.index',$course)}}" class="btn color-two button text-white">VIEW</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4>ANSWER CENTER</h4>
                                <a href="{{route('user.answer.ias-advance-morning')}}" class="btn color-two button text-white">VIEW</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
