    ...
    <div id="courses" class="wrap-bg wrap-bg-dark bg-bottom-zero p-0">
        <div class="container-fluid p-0 justify-content-center ">
            <div class="row justify-content-center pt-5 ">
                <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 p-0 course-animation mb20">
                    <!-- 2 -->
                    <div class="themeioan_course">
                        <article>
                            <!-- single course -->
                            <div class="blog-photo ">
                                <img class="img-fluid course-img" src="{{asset('cor/2.png')}}" alt="">
                            </div>
                            <div class="blog-content">
                                ...
                                <ul class="themeioan_ul_icon justify-content-center text-center">
                                    <li><a href="{{asset('/apsc/course/45')}}"
                                            class=" btn color-two button text-white mb-3">16 NOV</a></li>
                                </ul>
                            </div>
                        </article>
                        <!-- end single course -->
                ...
                <!--<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 p-0 course-animation mb20">-->
                <!-- 2 -->
                <!--    <div class="themeioan_course">-->
                <!--        <article>-->
                <!-- single course -->
                    ...
                    <div class="themeioan_course">
                        <article>
                            ...
                            <div class="blog-content">
                                ...
                                <ul class="themeioan_ul_icon justify-content-center text-center">
                                    <!--<li><a href="{{asset('/apsc/course/39')}}" class=" btn color-two button text-white mb-3">4 SEP</a></li>-->
                                    <li><a href="{{asset('/apsc/course/47')}}"
                                            class=" btn color-two button text-white mb-3">6 NOV</a></li>
                                </ul>
                            </div>
                        </article>
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 p-0 course-animation mb20">
                    ...
                    <div class="themeioan_course">
                        <article>
                            <!-- single course -->
                            <div class="blog-photo ">
                                <img class="img-fluid course-img" src="{{asset('storage/'.$course->image)}}" alt="">
                            </div>
                            <div class="blog-content">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 p-0 course-animation  mb20">
                    ...
                    <div class="themeioan_course">
                        <article>
                            <!-- single course -->
                            <div class="blog-photo ">
                                <img class="img-fluid course-img" src="{{asset('storage/'.$study->image)}}" alt="">
                            </div>
                            <div class="blog-content">
