...
<head>
    ...
    <!-- Title -->
    <title>APSC MAINS 2021 GS-4 - Academy of Civil Services</title>
    <!-- Favicon -->
                    ...
                    <div class="lernen_banner_title">
                        ...
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                ...
                                <span class="last-item">GS-4</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-5">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h4 class"text-uppercase">Ethics Class Ppt</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1W7KVsc5MzXfNcD6QUsKdkQxxJGjufcIi/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-5">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <!-- uses solid style -->
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4 class"text-uppercase">Ethics Material</h4>
                                <a href="{{asset('https://drive.google.com/file/d/11FvDJaTefL5oB8MOmrfWfyaFSIvc9bOt/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
