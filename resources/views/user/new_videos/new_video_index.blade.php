                    ...
                    <div class="row justify-content-center">
                            ...
                            <div class="single-features-light text-center bg-light">
                                ...
                                <div>
                                    ...
                                    <a href="{{route('user.new.video.prelims.topic',$course)}}" class=" btn color-two button text-white">Prelims</a><br>
                                </div>
                            </div>
                            <!-- end single features -->
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            ...
                            <div class="single-features-light text-center bg-light">
                                ...
                                <div>
                                    ...
                                    <a href="{{route('user.new.video.main.topic',$course)}}" class=" btn color-two button text-white">Main</a><br>
                                </div>
                            </div>
                            <!-- end single features -->
                        </div>
