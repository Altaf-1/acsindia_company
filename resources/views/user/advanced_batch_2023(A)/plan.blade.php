                                ...
                                <div>
                                    ...
                                    <h4>ECONOMY</h4>
                                     <form action="{{route('user.pdf-view.index')}}" method="post">
                                        ...
                                        <input type="hidden"
                                               name="drive_link"
                                               value="https://drive.google.com/file/d/1mmSjmGrCIxl7C8qGXLcny3RCT_zVQGYp/">
                            ...
                            <div class="single-features-light text-center">
                                ...
                                <div>
                                    ...
                                    <form action="{{route('user.pdf-view.index')}}" method="post">
                                        ...
                                        <input type="hidden"
                                               name="drive_link"
                                               value="https://drive.google.com/file/d/19Rcl7Mgp4kJaLUOlYLZVW95iGkGe9Ygk/">
                                        <button type="submit" class="btn color-two button text-white">Download</button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="single-features-light text-center">
                                ...
                                <div>
                                    ...
                                    <form action="{{route('user.pdf-view.index')}}" method="post">
                                        ...
                                        <input type="hidden"
                                               name="drive_link"
                                               value="https://drive.google.com/file/d/1Vcm67j3qPmF3Sunz-AYi3-L9xY6cTn4m/">
                                        <button type="submit" class="btn color-two button text-white">Download</button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="single-features-light text-center">
                                ...
                                <div>
                                    ...
                                    <form action="{{route('user.pdf-view.index')}}" method="post">
                                        ...
                                        <input type="hidden"
                                               name="drive_link"
                                               value="https://drive.google.com/file/d/1ni2JRTeaI-utOBpOZ2TEo-GTOu0BCl8z/">
                                        <button type="submit" class="btn color-two button text-white">Download</button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="single-features-light text-center">
                                ...
                                <div>
                                    ...
                                    <form action="{{route('user.pdf-view.index')}}" method="post">
                                        ...
                                        <input type="hidden"
                                               name="drive_link"
                                               value="https://drive.google.com/file/d/1iesW-mw6o2YzoNuD0sVcwp7Et0sh6VYJ/">
                                        <button type="submit" class="btn color-two button text-white">Download</button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="single-features-light text-center">
                                ...
                                <div>
                                    ...
                                    <form action="{{route('user.pdf-view.index')}}" method="post">
                                        ...
                                        <input type="hidden"
                                               name="drive_link"
                                               value="https://drive.google.com/file/d/10xnXXrOfyJgC7_3tzPbux_Ned1wu-j96/">
                                        <button type="submit" class="btn color-two button text-white">Download</button>
                                    </form>
                                </div>
                            </div>
