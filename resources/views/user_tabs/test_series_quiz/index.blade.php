                    ...
                    <div class="lernen_banner_title">
                        ...
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                ...
                                <span class="last-item">TEST SERIES</span>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 mb-4 ">
                                <div class="single-features-light text-center bg-light">
                                    <div>
                                        ...
                                        <a href="{{ route('testseriesquiz.questions', [$data->test_series_quiz_id, $data->course_name, $type]) }}"
                                        ...
                                        <!--@if ($data->test_series_quiz->pdf)-->
                                        <!--    <a href="{{ asset('storage/' . $data->test_series_quiz->pdf) }}"-->
                                        <!--        target="_blank" class="btn color-two button text-white">PDF VIEW</a>-->
                                        <!--@endif-->
                                    </div>
                                </div>
                            </div>
