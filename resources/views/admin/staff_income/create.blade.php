...
@section('content')
    ...
    <div class="container emp-profile mt-3">
        <form action="{{route('admin.staff-income.store-salary')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="borderDiv">
                ...
                <div class="row bg-transparent">
                    ...
                    <div class="col-lg-4 p-2">
                        ...
                        <input id="basic" type="text" class="form-control @error('basic') is-invalid @enderror" readonly
            ...
            <div class="borderDiv">
                ...
                <div class="row bg-transparent">
                    <div class="col-lg-6 p-2">
                        ...
                        <input onchange="getNet()" id="earning" type="number" class="form-control"
                               name="earning" placeholder="Earning Amount"
                               value="{{old('earning')}}">
                    </div>
                    <div class="col-lg-6 p-2">
                        <label for="earning_reason">Earning Reason</label>
                       <textarea class="form-control" rows="3" name="earning_reason" placeholder="Enter Earning Reason"></textarea>
                    </div>

                    <div class="col-lg-6 p-2">
                        <label for="deduction">Deduction</label>
                        <input  onchange="getNet()" id="deduction" type="number" class="form-control"
                    ...
                    <div class="col-lg-6 p-2">
                        ...
                        <textarea class="form-control" rows="3" name="deduction_reason" placeholder="Enter Deduction Reason"></textarea>
                    </div>
