...
<head>
    ...
    <!-- Title -->
    <title>APSC MAINS 2021 GS-3 - Academy of Civil Services</title>
    <!-- Favicon -->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse " id="navbarCollapse">
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <li class="subnav">
                            <a href="#features">SECURITY GS-3</a>
                        </li>
                    </ul>
                </div>
                <!-- Menu Toogle end -->
                    ...
                    <div class="lernen_banner_title">
                        ...
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                ...
                                <span class="last-item">SECURITY GS-3</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-5">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h4 class"text-uppercase">Class PPT</h4>
                                <a href="{{asset('https://drive.google.com/file/d/13xy5rFdfShS2i-QE_C3PmQhtYEwkqeyr/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-5">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <!-- uses solid style -->
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4 class"text-uppercase">class material</h4>
                                <a href="{{asset('https://drive.google.com/file/d/13MF2CnS7rLNfN1UvkxfJhltrCkczmrR2/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
