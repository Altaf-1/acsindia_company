                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                ...
                                <h4>2014</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1fUufgdBQFthjqRDP8woH7DeVNiOVckxn/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>2015</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1uO7qkZ-Lyn1TXCyX-4-r5O24wHetXnZt/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>2016</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1yN12BrktBBIaQ64_4sJnNnbernYN78Zo/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>2017</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1NlFqaSOAdt3iUDxbfTqCaM2EcM9oEowB/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>2018</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1vyChKVeW8DeFnk-G3L0O5_VObNoEzndW/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>2019</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1qwz1t3SmF8HYhQ2Id6UAkwIat4C8MBDx/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>2020</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1gkh_-Javr6n61VCwzr8UkFlsVa_gdorM/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
