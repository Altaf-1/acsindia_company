...
<style>
    ...
    .slider-bg1 {
        background: url("{{asset('comimages/uniweb/11.png')}}") no-repeat;
        background-size: 100% 100%;
    }

    .slider-bg2 {
        background: url("{{asset('comimages/uniweb/22.png')}}") no-repeat;
        background-size: 100% 100%;
    ...
    @media screen and (max-width: 515px) {
        ...
        .slider-bg1 {
            background: url('{{asset('comimages/unimob/m1.png')}}') no-repeat;
            background-size: 100% 100%;
            height: 80vh !important;
        }

        .slider-bg2 {
            background: url("{{asset('comimages/unimob/mm2.png')}}") no-repeat;
            background-size: 100% 100%;
            height: 80vh !important;
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse " id="navbarCollapse">
            <ul class="nav navbar-nav ml-auto text-center active">
                ...
                <li class="subnav">
                    <div class="dropdown">
                        <button class="dropbtn">UPSC</button>
                        <div class="dropdown-content">
                            <a href="https://acsindiaias.com/course">Online Courses</a>
                            <a href="https://acsindiaias.com/syllabus">Syllabus</a>
                            <a href="https://acsindiaias.com/previous">Previous year Question Paper</a>
                ...
                <li class="subnav">
                    <div class="dropdown">
                        <button class="dropbtn">APSC</button>
                        <div class="dropdown-content">
                            <a href="https://acsindiaias.com/apsc/courses">APSC Online Courses</a>
                            <a href="https://acsindiaias.com/syllabus">APSC Syllabus</a>
                            <a href="https://acsindiaias.com/previous">APSC Previous year Question Paperr</a>
                            <a href="https://acsindiaias.com/digipedia">APSC NCERT bOOKS</a>
                ...
                <li class="nav-item dropdown">
                    <a id="navbarDropdown" class="nav-link dropdown-toggle bg-dark text-white p-3" href="#" role="button"
...
<main>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        <ol class="carousel-indicators">
            <a href="https://acsindiaias.com/upsc"><li data-target="#carouselExampleIndicators" data-slide-to="0" class="active"></li></a>
            <a href="https://acsindiaias.com/apsc"><li data-target="#carouselExampleIndicators" data-slide-to="0" class="active"></li></a>
    ...
    <div id="rs-categories" class="rs-categories gray-bg style1 pt-94 pb-70 md-pt-64 md-pb-40">
        <div class="container">
            ...
            <div class="row">
									<div class="col-lg-4 col-sm-4 col-md-4 text-center justify-content-center p-1" >
									...
									<a href="/upsc"><h4 style="background-color: #134982" class="d-flex flex-column btn text-white p-2">UPSC PREPARATION
</h4></i></a>
									</div>
									<div class="col-lg-4 col-sm-4 col-md-4 text-center justify-content-center p-1" >
									...
									<a href="/apsc"><h4 style="background-color: #134982" class="d-flex flex-column btn text-white p-2">APSC PREPARATION</h4></i></a>
									</div>
									<div class="col-lg-4 col-sm-4 col-md-4 text-center justify-content-center p-1" >
									...
									<a href="https://acsindiaias.com/self-study"><h4 style="background-color: #134982" class="d-flex flex-column btn text-white p-2">SEIF STUDY</h4></i></a>
									</div>
