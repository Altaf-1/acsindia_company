            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse " id="navbarCollapse">
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <li class="subnav">
                            <a href="#features">ASSAM CURRENT AFFAIRS</a>
                        </li>
                    </ul>
                </div>
                <!-- Menu Toogle end -->
            ...
            <div class="container">
                <div class="row">
                    <div class="lernen_banner_title">
                        <h1>ASSAM CURRENT AFFAIRS</h1>
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                <span class="first-item">
									<a href="/">Homepage</a></span>
                                <span class="separator">&gt;</span>
                                <span class="last-item">ASSAM CURRENT AFFAIRS</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                ...
                                <h4>AUGUST</h4>
                                <a href="https://drive.google.com/file/d/1KuGT6v6FcYi7E6HSLrpoqqht5lUgzbpV/view?usp=sharing" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>SEPTEMBER</h4>
                                <a href="https://drive.google.com/file/d/1VYoGVdb9-jUwW2QJ47fz1wG9uX7tjXP4/view?usp=sharing" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>OCTOBER</h4>
                                <a href="https://drive.google.com/file/d/1ZUKoweFX_Llu4pd9hpnXXYTIC0BH48th/view?usp=sharing" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    </div><div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ml-5 pt-2">
                        <!-- 2 -->
                        <div class="single-features-light text-center bg-light">
                            <!-- single features -->
                            <div>
                                ...
                                <a href="https://drive.google.com/file/d/1IMmG_uxqYwwcJpYq2BczNncSZBubMpiA/view?usp=sharing" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
