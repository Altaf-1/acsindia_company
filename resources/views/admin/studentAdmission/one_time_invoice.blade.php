...
@section('title')
    Student Admission One Time Invoice
@endsection
@section('links')
...
@section('content')
    ...
    <table border class="invoice w-75">
        ...
        <tr>
            <td colspan="2" rowspan="2"><h5 class="d-flex justify-content-end">{{$student->class}}</h5></td>
        ...
        <!--Transaction amount-->
            <tr>
                <td colspan="6"><h5 class="d-flex justify-content-end ">Early Bird Discount</h5></td>
                <td><h5 class="d-flex justify-content-end">10000</h5></td>
                <td><h5 class="d-flex justify-content-end ">{{$student->course_price - 10000}}</h5></td>
            </tr>
        <tr>
        ...
        <tr>
            <td colspan="4"><h5 class="header-main m-0">Paid Amount</h5></td>
            <td><h5 class="d-flex justify-content-end">
                {{number_format((float)(( ($student->course_price - 10000 )/118) * 100), 0, '.', '')}}
            </td>
            <td><h5 class="d-flex justify-content-end">
                    9%
                </h5></td>
            <td><h5 class="d-flex justify-content-end">
                    {{number_format((float)((number_format((float)(( ($student->course_price - 10000)/118) * 100), 0, '.', '')) * (9/100)),0,'.','')}}</h5></td>
            <td><h5 class="d-flex justify-content-end">
                    9%
                </h5></td>
            <td><h5 class="d-flex justify-content-end">{{number_format((float)((number_format((float)((($student->course_price - 10000)/118) * 100), 0, '.', '')) * (9/100)),0,'.','')}}</h5></td></h5></td>
            <td><h5 class="d-flex justify-content-end">{{($student->course_price - 10000)}}</h5></td>
        </tr>
        <tr>
            <td colspan="10">
                <input type="hidden" id="amount_value" value="{{($student->course_price - 10000)}}">
