...
<head>
    ...
    <!-- Title -->
    <title>Question Paper - Academy of Civil Services</title>
    <!-- Favicon -->
    <link rel="shortcut icon" href="comimages/gbar.webp" type="image/x-icon">
    <!-- Bootstrap  -->
    ...
    <style type="text/css">
        .bg-courses {
            background-image: url('comimages/corbg.webp');
            ...
            <div class="container">
                <div class="row">
                    <div class="lernen_banner_title">
                        <h2 class="text-white">Previous year UPSC question paper</h2>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h4>ART & CULTURE</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1KOkRJ9aP8cDp92QHrR1Os64Z-EI8ZwEj/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <a href="{{asset('https://drive.google.com/file/d/1RTQixFvTe-J1BzS-5pCgUy0ApxZz4Pdv/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4>HISTORY</h4>
                                <a href="{{asset('https://drive.google.com/file/d/16SmV42y5fkFiTHWOiHnRHBFnpTrSy2Ex/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
