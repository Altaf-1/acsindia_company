...
<head>
    ...
    <!-- Title -->
    <title>APSC MAINS 2021 GS-5 - Academy of Civil Services</title>
    <!-- Favicon -->
            ...
            <div class="container">
                <div class="row">
                    <div class="lernen_banner_title">
                        <h1>APSC MAINS 2021 GS-5</h1>
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                <span class="first-item">
									<a href="/">Homepage</a></span>
                                <span class="separator">&gt;</span>
                                <span class="last-item">GS-5</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h4 class="text-uppercase">Assam History and Culture</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1nNxSTJ-49LO5Adf9iy8AXKfQhp-VU-Q3/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4 class="text-uppercase">Assam Geography</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1JWdUrlYptDoLAoOC7dvBxkFShYjo1bbM/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                <i class="base-color fab fa-leanpub fa-3x"></i>
                                <h4 class="text-uppercase">Assam Schemes</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1iWMD5MH6RBkeKHbKZzEjSz2uzAUzULj9/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <a href="{{asset('https://drive.google.com/file/d/1_nw6n2Of3jmda0DYQ9OhLo0EVMMj0LwL/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
