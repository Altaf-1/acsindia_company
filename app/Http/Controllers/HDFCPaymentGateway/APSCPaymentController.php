...
class APSCPaymentController extends Controller
{
    ...
    {
        $course = ApscCourses::where('slug', $course)->get()->first();
        $user = Auth::user();
    ...
    public function complete_pending_order($order_id): Factory|\Illuminate\View\View|Application
    {
        ...
        $course = ApscCourses::where('id', $order->course_id)->get()->first();
        $user = Auth::user();
    ...
    public function response(Request $request): RedirectResponse
    {
        try{
            ...
            $course = ApscCourses::findOrFail($hdfcOrder->first()->course_id);
            ...
            $user->apsc_courses()->attach($hdfcOrder->first()->course_id);
            ...
            Invoice::create([
                ...
                'payment_id' => $hdfcOrder->first()->payment_id,
                 'mode' => 'HDFC',
                'course' => ApscCourses::findOrFail($hdfcOrder->first()->course_id)->title,
