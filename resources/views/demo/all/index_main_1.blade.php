...
<main>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 pl-60 order-last pt-5">
						<div class="img-part mt-5 pl-5">
							<img class="up-down-new" style="height:55%;" src="{{asset('comimages/home12/flag-2.png')}}" alt="">
						</div>
					</div>
					<div class="col-lg-6 pr-0 pt-5">
						<div class="banner-content mb-5">
							...
							<div>
							    <center><a href="#apscpre" style="box-shadow: 5px 10px #888888;" class="readon green-banner mt-4">TARGET APSC</a></center>
							</div>
				...
				<div class="section-title">
					<div>
						...
						<h4 data-aos="fade-left">Aspirations of Academy of Civil Services move hand in hand with the Indian Civil Services Aspirants.
							...
							learning at an affordable price for each fellow Indian.
						</h4>
						<br>
						...
						<h4 data-aos="fade-left">Our each session starts with a mission to promote smart work, patience and perseverance among the students.
							We pledge to give guidance to our aspirants till they land in success
						</h4>
					</div>
				</div>
			</div>
					...
					<div class="col-lg-6 mt-2 col-sm-12 col-xs-12">
						<div class="single-features-light text-center shadow rounded" style="background-color: #92089e;">
							...
							<div class="move">
								...
								<a href="{{route('current.affair.index')}}">
								...
								<div class="feature_link">
									<a href="{{route('current.affair.index')}}" class="text-white">Click here <i class="fas fa-arrow-right"></i></a>
								</div>
							</div>
						</div>
					</div>
	...
	<!-- Apsc Section -->
	<div id="apscpre" class="m-4">
		<div class="text-center container-fluid p-2 mb-2 post-heading-center mb-60" style="background-color: #0c8b51;">
			<h2 data-aos="fade-right" class="text-white ml2">GEAR UP FOR APSC</h2>
		</div>
		<div class="row">
			<div data-aos="fade-right" class=" col-xs-12 col-sm-12 col-md-5 col-xl-6 col-lg-5 why-us-left-bg">
				<img style="height:550px; width:800px" target="_blank" src="{{asset('comimages/apsc/banner-about.png')}}"/></a>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-7 col-xl-6 col-lg-7 wrap-padding">
				<div class="section-title">
					<div>
						...
						<a href="{{route('apsc_rank')}}" style="box-shadow: 5px 10px #888888;"  class="readon green-banner mt-4">Get Insights From Our TOPPERS </a><br>
						<a href="/apsc" style="box-shadow: 5px 10px #888888;" class="readon green-banner mt-4">VISIT APSC SITE</a>
					</div>
				</div>
			</div>
		</div>
	...
	<section id="review">
		<div>
			<div class="text-center p-4" style="background-color: #0c8b51;">
				<h2 class="text-white">
					STUDENTS  
					<spam class="pl-3 pr-3" style="background-color: #d99032;">GOOGLE</spam>
					REVIEWS
				</h2>
			</div>
		</div>
			...
			<div class="col-lg-6">
				<div class="event-photo themeioan_event">
					<div class="date" style="background-color: #92089e;">
						<h4><span>14</span> August, 2022</h4>
					</div>
			...
			<div class="col-lg-6">
				<div class="d-flex flex-column">
					...
					<div class="btn-section">
						<form action="{{route('webinar-registration.create',81572938528)}}">
							<button type="submit" style="width:250px;">
								<span>Book Now</span>
								<div class="liquid"></div>
							</button>
