            ...
            <div class="container">
                <div class="row">
                    <div class="lernen_banner_title">
                        <h1>WELCOME TO DIGIPEDIA</h1>
                        <div class="lernen_breadcrumb">
                            <div class="breadcrumbs">
                                <span class="first-item">
									<a href="/">Homepage</a></span>
                                <span class="separator">&gt;</span>
                                <span class="last-item">Digipedia</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                ...
                                <h4>NCERT BOOKS</h4>
                                <a href="/digipedia" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>IAS SYLLABUS</h4>
                                <a href="/syllabus" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3 ">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                ...
                                <a href="/previous" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3 ">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>ACS WISDOM 2023</h4>
                                <a href="/acsyear" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                    ...
                    <!--        <div>-->
                    <!--            <i class="base-color fas fa-book fa-3x"></i>-->
                    <!--            <h4>UPSC EXAM CALENDAR</h4>-->
                    <!--            <a href="{{asset('https://drive.google.com/file/d/1IKJ-DOUCc3YAVwRH7HFEafHfCTg2jhRB/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>-->
                    <!--        </div>-->
                    <!--    </div>-->
                        <!-- end single features -->
                    <!--</div>-->
                    <div class="col-xs-12 col-sm-12 col-md-3 mt-3">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                ...
                                <h4>UPSC SYLLABUS</h4>
                                <h4>(AT A GLANCE)</h4>
                                <a href="{{asset('https://drive.google.com/file/d/1v0YFxG-sLZfzbwIQhRqV3pG451rOduIm/view?usp=sharing')}}" class=" btn color-two button text-white">DOWNLOAD</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
