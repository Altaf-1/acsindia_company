    ...
    <div class="fullwidth-template mt-3">
        <div class="slide-home-03">
            <div class="response-product product-list-owl owl-slick equal-container better-height"
                    ...
                    <div class="slide-info">
                        <div class="container">
                            <div class="slide-inner">
                                ...
                                <h5><span><i class="fa fa-phone fa-phone-top"></i> </span> 9287958404</h5>
                                <a href="{{route('free.trial.course')}}" class="shadow_1" style="background-color: #e52e06; font-family: 'Righteous';">JOIN DEMO CLASS</a>
                ...
                <div class="slide-wrap">
                    <img src="{{asset('comimages/2023/ap11.webp')}}" alt="image">
                    <div class="slide-info">
                        <div class="container">
                            <div class="slide-inner">
                                <h1 style="font-family: 'Righteous';">APSC </h1>
                                <h5>Online/Offline</h5>
                                <h5><spam><i class="fa fa-phone fa-phone-top"></i> </spam> 9287958404</h5>
                                <a href="{{route('free.trial.course')}}" class="shadow_1" style="background-color: #e52e06; font-family: 'Righteous';">JOIN DEMO CLASS</a>
                            </div>
                        </div>
                    </div>
