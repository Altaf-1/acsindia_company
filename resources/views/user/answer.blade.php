...
<head>
    ...
    <!-- Title -->
    <title>Answer Center - Academy of Civil Services</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="lernen_banner_title">
                        <h2 class="text-white">ANSWER CENTER</h2>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        ...
                        <div class="single-features-light text-center">
                            ...
                            <div>
                                ...
                                <h4>TEST NAME : {{$answer->test_name}}</h4>
                                <h4>DATE : {{$answer->date}}</h4>
                                <a href="{{$answer->pdf}}" class="btn color-two button text-white">SEE ANSWER EXPLANATION</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
