                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 mt-2">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                <!-- uses solid style -->
                                <i class="base-color fas fa-book fa-3x"></i>
                                <h4>ORGANIZATIONS & GROUPINGS</h4>
                                <a href="https://drive.google.com/file/d/15TGvztZMNHCN_fByR-vyR7mG8JDNw62o/view?usp=sharing" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
                     ...
                     <div class="col-xs-12 col-sm-12 col-md-4 mt-2">
                        ...
                        <div class="single-features-light text-center bg-light">
                            ...
                            <div>
                                ...
                                <a href="https://drive.google.com/file/d/1Sr7lJBCnCrTnXoqJoBgEZlw2D5izPrzm/view?usp=sharing" class=" btn color-two button text-white">OPEN</a>
                            </div>
                        </div>
                        <!-- end single features -->
                    </div>
