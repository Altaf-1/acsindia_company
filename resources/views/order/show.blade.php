            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-12"><strong>Course Name :</strong> {{$order->course->title}}</div>
                        ...
                        <div class="d-flex">
                            <div class="justify-content-start">
                                <a class="btn btn-primary text-white"
                                   href="{{route('order.pending.payment',$order->id)}}">
                                    Pay Now</a>
                            </div>
                            <div class="justify-content-end">

                                <form action="{{route('upsc.order.delete',$order->id)}}"
                                      method="post">
                                    @csrf
                                    @method('DELETE')
